...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        if (!Schema::hasTable('acc_1102050101_702'))
        {
            Schema::create('acc_1102050101_702', function (Blueprint $table) {
                $table->bigIncrements('acc_1102050101_702_id'); 
    ...
    {
        Schema::dropIfExists('acc_1102050101_702');
    }
};
