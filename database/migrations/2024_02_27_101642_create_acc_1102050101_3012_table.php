...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('acc_1102050101_3012'))
        {
            Schema::create('acc_1102050101_3012', function (Blueprint $table) {
                $table->bigIncrements('acc_1102050101_3012_id'); 
                ...
                $table->string('nhso_ownright_name')->nullable();//   วันที่    
    ...
    {
        Schema::dropIfExists('acc_1102050101_3012');
    }
};
