...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_api12002_ldv'))
        {
            Schema::create('d_api12002_ldv', function (Blueprint $table) {
                $table->bigIncrements('d_api12002_ldv_id'); 
    ...
    {
        Schema::dropIfExists('d_api12002_ldv');
    }
};
