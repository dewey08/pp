...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_api12002_ins'))
        {
            Schema::create('d_api12002_ins', function (Blueprint $table) {
                $table->bigIncrements('d_api12002_ins_id'); 
    ...
    {
        Schema::dropIfExists('d_api12002_ins');
    }
};
