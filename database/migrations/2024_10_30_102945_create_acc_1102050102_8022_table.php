...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('acc_1102050102_8022'))
        {
            Schema::create('acc_1102050102_8022', function (Blueprint $table) {
                $table->bigIncrements('acc_1102050102_8022_id'); 
    ...
    {
        Schema::dropIfExists('acc_1102050102_8022');
    }
};
