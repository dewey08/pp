...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apicrrt_pat'))
        {
            Schema::create('d_apicrrt_pat', function (Blueprint $table) {
                $table->bigIncrements('d_apicrrt_pat_id'); 
    ...
    {
        Schema::dropIfExists('d_apicrrt_pat');
    }
};
