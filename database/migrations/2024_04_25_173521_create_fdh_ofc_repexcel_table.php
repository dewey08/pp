...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('fdh_ofc_repexcel'))
        {
            Schema::connection('mysql')->create('fdh_ofc_repexcel', function (Blueprint $table) { 
                $table->bigIncrements('fdh_ofc_repexcel_id');//  
    ...
    {
        Schema::dropIfExists('fdh_ofc_repexcel');
    }
};
