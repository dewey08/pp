...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('acc_1102050102_801send'))
        {
            Schema::create('acc_1102050102_801send', function (Blueprint $table) {
                $table->bigIncrements('acc_1102050102_801send_id');
    ...
    {
        Schema::dropIfExists('acc_1102050102_801send');
    }
};
