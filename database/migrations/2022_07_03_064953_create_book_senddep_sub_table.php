...
return new class extends Migration
{
    ...
    public function up()
    { 
        if (!Schema::hasTable('book_senddep_sub'))
        {
        Schema::create('book_senddep_sub', function (Blueprint $table) {
            $table->bigIncrements('senddepsub_id'); 
            $table->string('bookrep_id',100)->nullable();//
            $table->string('senddep_depsub_id')->nullable();// 
            $table->string('senddep_depsub_name',255)->nullable();//         
    ...
    {
        Schema::dropIfExists('book_senddep_sub');
    }
};
