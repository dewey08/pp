...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_api12002_aer'))
        {
            Schema::create('d_api12002_aer', function (Blueprint $table) {
                $table->bigIncrements('d_api12002_aer_id'); 
    ...
    {
        Schema::dropIfExists('d_api12002_aer');
    }
};
