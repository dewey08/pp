...
return new class extends Migration
{
    ...
    public function up()
    { 
        if (!Schema::hasTable('d_aipn_session'))
        {
            Schema::connection('mysql')->create('d_aipn_session', function (Blueprint $table) {
                $table->bigIncrements('d_aipn_session_id'); 
    ...
    {
        Schema::dropIfExists('d_aipn_session');
    }
};
