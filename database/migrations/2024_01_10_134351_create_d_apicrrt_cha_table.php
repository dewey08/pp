...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apicrrt_cha'))
        {
            Schema::create('d_apicrrt_cha', function (Blueprint $table) {
                $table->bigIncrements('d_apicrrt_cha_id'); 
    ...
    {
        Schema::dropIfExists('d_apicrrt_cha');
    }
};
