...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apicrrt_odx'))
        {
            Schema::create('d_apicrrt_odx', function (Blueprint $table) {
                $table->bigIncrements('d_apicrrt_odx_id'); 
    ...
    {
        Schema::dropIfExists('d_apicrrt_odx');
    }
};
