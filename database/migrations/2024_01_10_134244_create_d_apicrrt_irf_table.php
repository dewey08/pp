...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apicrrt_irf'))
        {
            Schema::create('d_apicrrt_irf', function (Blueprint $table) {
                $table->bigIncrements('d_apicrrt_irf_id'); 
    ...
    {
        Schema::dropIfExists('d_apicrrt_irf');
    }
};
