...
return new class extends Migration
{
    ...
    public function up()
    { 
        if (!Schema::hasTable('d_rep_eclaim'))
        {
            Schema::connection('mysql')->create('d_rep_eclaim', function (Blueprint $table) {
                $table->bigIncrements('d_rep_eclaim_id'); 
    ...
    {
        Schema::dropIfExists('d_rep_eclaim');
    }
};
