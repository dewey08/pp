...
return new class extends Migration
{
    ...
    { 
        ...
        Schema::create('warehouse_pay_sub', function (Blueprint $table) {
            ...
            $table->string('product_pay_qty')->nullable();  //จ่ายจำนวน
            $table->string('product_pay_price')->nullable();  //จ่ายราคา
            $table->string('product_pay_price_total')->nullable();  //จ่ายยอดรวมราคา

            $table->date('warehouse_rep_sub_exedate')->nullable();//วันที่ผลิต     
            $table->date('warehouse_rep_sub_expdate')->nullable();//วันที่หมดอายุ 

            $table->string('warehouse_pay_sub_status')->nullable();  //สถานะ  
            $table->string('warehouse_pay_sub_total')->nullable();  //Totl  
