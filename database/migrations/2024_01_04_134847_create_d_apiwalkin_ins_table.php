...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apiwalkin_ins'))
        {
            Schema::create('d_apiwalkin_ins', function (Blueprint $table) {
                $table->bigIncrements('d_apiwalkin_ins_id'); 
    ...
    {
        Schema::dropIfExists('d_apiwalkin_ins');
    }
};
