...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('acc_stm_sssnew'))
        {
            Schema::create('acc_stm_sssnew', function (Blueprint $table) {
                $table->bigIncrements('acc_stm_sssnew_id'); 
    ...
    {
        Schema::dropIfExists('acc_stm_sssnew');
    }
};
