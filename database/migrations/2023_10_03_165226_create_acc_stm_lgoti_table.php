...
return new class extends Migration
{
    ...
    public function up()
    { 
        if (!Schema::hasTable('acc_stm_lgoti'))
        {
            Schema::connection('mysql')->create('acc_stm_lgoti', function (Blueprint $table) {
                $table->bigIncrements('acc_stm_lgoti_id'); 
    ...
    {
        Schema::dropIfExists('acc_stm_lgoti');
    }
};
