...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('acc_nongtoon_repexcel'))
        {
            Schema::create('acc_nongtoon_repexcel', function (Blueprint $table) {
                $table->bigIncrements('acc_nongtoon_repexcel_id');
    ...
    {
        Schema::dropIfExists('acc_nongtoon_repexcel');
    }
};
