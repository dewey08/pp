...
return new class extends Migration
{
    ...
    public function up()
    {
        if (!Schema::hasTable('check_authenexcel'))
        {
        Schema::create('check_authenexcel', function (Blueprint $table) {
            $table->bigIncrements('check_authenexcel_id');
    ...
    {
        Schema::dropIfExists('check_authenexcel');
    }
};
