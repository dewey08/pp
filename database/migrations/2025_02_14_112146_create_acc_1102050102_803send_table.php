...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('acc_1102050102_803send'))
        {
            Schema::create('acc_1102050102_803send', function (Blueprint $table) {
                $table->bigIncrements('acc_1102050102_803send_id');
    ...
    {
        Schema::dropIfExists('acc_1102050102_803send');
    }
};
