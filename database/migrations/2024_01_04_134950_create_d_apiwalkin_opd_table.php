...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apiwalkin_opd'))
        {
            Schema::create('d_apiwalkin_opd', function (Blueprint $table) {
                $table->bigIncrements('d_apiwalkin_opd_id'); 
    ...
    {
        Schema::dropIfExists('d_apiwalkin_opd');
    }
};
