...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_api12002_pat'))
        {
            Schema::create('d_api12002_pat', function (Blueprint $table) {
                $table->bigIncrements('d_api12002_pat_id'); 
    ...
    {
        Schema::dropIfExists('d_api12002_pat');
    }
};
