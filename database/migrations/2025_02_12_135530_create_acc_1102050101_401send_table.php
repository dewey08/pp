...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('acc_1102050101_401send'))
        {
            Schema::create('acc_1102050101_401send', function (Blueprint $table) {
                $table->bigIncrements('acc_1102050101_401send_id');
    ...
    {
        Schema::dropIfExists('acc_1102050101_401send');
    }
};
