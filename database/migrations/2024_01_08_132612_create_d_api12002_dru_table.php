...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_api12002_dru'))
        {
            Schema::create('d_api12002_dru', function (Blueprint $table) {
                $table->bigIncrements('d_api12002_dru_id'); 
    ...
    {
        Schema::dropIfExists('d_api12002_dru');
    }
};
