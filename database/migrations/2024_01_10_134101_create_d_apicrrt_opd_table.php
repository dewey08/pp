...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apicrrt_opd'))
        {
            Schema::create('d_apicrrt_opd', function (Blueprint $table) {
                $table->bigIncrements('d_apicrrt_opd_id'); 
    ...
    {
        Schema::dropIfExists('d_apicrrt_opd');
    }
};
