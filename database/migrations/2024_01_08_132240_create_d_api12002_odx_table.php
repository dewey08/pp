...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_api12002_odx'))
        {
            Schema::create('d_api12002_odx', function (Blueprint $table) {
                $table->bigIncrements('d_api12002_odx_id'); 
    ...
    {
        Schema::dropIfExists('d_api12002_odx');
    }
};
