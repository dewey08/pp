...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apiwalkin_ldv'))
        {
            Schema::create('d_apiwalkin_ldv', function (Blueprint $table) {
                $table->bigIncrements('d_apiwalkin_ldv_id'); 
    ...
    {
        Schema::dropIfExists('d_apiwalkin_ldv');
    }
};
