...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('acc_lgo_rep'))
        {
            Schema::create('acc_lgo_rep', function (Blueprint $table) {
                $table->bigIncrements('acc_lgo_rep_id'); 
                ...
                $table->string('income_claim')->nullable();          // ag   เบิกได้
                $table->string('income_noclaim')->nullable();          //ah   เบิกไม่ได้
    ...
    {
        Schema::dropIfExists('acc_lgo_rep');
    }
};
