...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apiwalkin_dru'))
        {
            Schema::create('d_apiwalkin_dru', function (Blueprint $table) {
                $table->bigIncrements('d_apiwalkin_dru_id'); 
    ...
    {
        Schema::dropIfExists('d_apiwalkin_dru');
    }
};
