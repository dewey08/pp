...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apiwalkin_oop'))
        {
            Schema::create('d_apiwalkin_oop', function (Blueprint $table) {
                $table->bigIncrements('d_apiwalkin_oop_id'); 
    ...
    {
        Schema::dropIfExists('d_apiwalkin_oop');
    }
};
