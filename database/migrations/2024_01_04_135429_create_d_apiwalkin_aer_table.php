...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apiwalkin_aer'))
        {
            Schema::create('d_apiwalkin_aer', function (Blueprint $table) {
                $table->bigIncrements('d_apiwalkin_aer_id'); 
    ...
    {
        Schema::dropIfExists('d_apiwalkin_aer');
    }
};
