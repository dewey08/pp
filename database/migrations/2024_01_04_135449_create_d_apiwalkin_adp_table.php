...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apiwalkin_adp'))
        {
            Schema::create('d_apiwalkin_adp', function (Blueprint $table) {
                $table->bigIncrements('d_apiwalkin_adp_id'); 
    ...
    {
        Schema::dropIfExists('d_apiwalkin_adp');
    }
};
