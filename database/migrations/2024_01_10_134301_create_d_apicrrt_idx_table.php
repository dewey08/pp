...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apicrrt_idx'))
        {
            Schema::create('d_apicrrt_idx', function (Blueprint $table) {
                $table->bigIncrements('d_apicrrt_idx_id'); 
    ...
    {
        Schema::dropIfExists('d_apicrrt_idx');
    }
};
