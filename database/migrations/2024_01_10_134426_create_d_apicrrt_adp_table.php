...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apicrrt_adp'))
        {
            Schema::create('d_apicrrt_adp', function (Blueprint $table) {
                $table->bigIncrements('d_apicrrt_adp_id'); 
    ...
    {
        Schema::dropIfExists('d_apicrrt_adp');
    }
};
