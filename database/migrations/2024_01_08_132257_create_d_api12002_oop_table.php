...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_api12002_oop'))
        {
            Schema::create('d_api12002_oop', function (Blueprint $table) {
                $table->bigIncrements('d_api12002_oop_id'); 
    ...
    {
        Schema::dropIfExists('d_api12002_oop');
    }
};
