...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apiwalkin_pat'))
        {
            Schema::create('d_apiwalkin_pat', function (Blueprint $table) {
                $table->bigIncrements('d_apiwalkin_pat_id'); 
    ...
    {
        Schema::dropIfExists('d_apiwalkin_pat');
    }
};
