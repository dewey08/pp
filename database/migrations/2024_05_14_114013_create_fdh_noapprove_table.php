...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('fdh_noapprove'))
        {
            Schema::connection('mysql')->create('fdh_noapprove', function (Blueprint $table) {
                $table->bigIncrements('fdh_noapprove_id');
    ...
    {
        Schema::dropIfExists('fdh_noapprove');
    }
};
