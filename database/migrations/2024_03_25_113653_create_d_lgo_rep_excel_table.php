...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_lgo_rep_excel'))
        {
            Schema::connection('mysql')->create('d_lgo_rep_excel', function (Blueprint $table) {
                $table->bigIncrements('d_lgo_rep_excel_id'); 
    ...
    {
        Schema::dropIfExists('d_lgo_rep_excel');
    }
};
