...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('vaccine_big_excel'))
        {
            Schema::create('vaccine_big_excel', function (Blueprint $table) {
                $table->bigIncrements('vaccine_big_excel_id'); 
    ...
    {
        Schema::dropIfExists('vaccine_big_excel');
    }
};
