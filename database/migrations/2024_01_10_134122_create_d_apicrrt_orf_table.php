...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apicrrt_orf'))
        {
            Schema::create('d_apicrrt_orf', function (Blueprint $table) {
                $table->bigIncrements('d_apicrrt_orf_id'); 
    ...
    {
        Schema::dropIfExists('d_apicrrt_orf');
    }
};
