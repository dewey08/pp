...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apiwalkin_orf'))
        {
            Schema::create('d_apiwalkin_orf', function (Blueprint $table) {
                $table->bigIncrements('d_apiwalkin_orf_id'); 
    ...
    {
        Schema::dropIfExists('d_apiwalkin_orf');
    }
};
