...
return new class extends Migration
{
    ...
    public function up()
    { 
        if (!Schema::hasTable('check_authen_temp'))
        {
        Schema::create('check_authen_temp', function (Blueprint $table) {
            $table->bigIncrements('check_authen_temp_id');  
                ...
                $table->string('claimtype')->nullable();// ประเภทการเข้ารับบริการ
                $table->string('servicerep')->nullable();// รหัสบริการ
    ...
    {
        Schema::dropIfExists('check_authen_temp');
    }
};
