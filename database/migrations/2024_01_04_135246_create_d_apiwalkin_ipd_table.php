...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apiwalkin_ipd'))
        {
            Schema::create('d_apiwalkin_ipd', function (Blueprint $table) {
                $table->bigIncrements('d_apiwalkin_ipd_id'); 
    ...
    {
        Schema::dropIfExists('d_apiwalkin_ipd');
    }
};
