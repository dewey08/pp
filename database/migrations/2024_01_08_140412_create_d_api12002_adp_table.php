...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_api12002_adp'))
        {
            Schema::create('d_api12002_adp', function (Blueprint $table) {
                $table->bigIncrements('d_api12002_adp_id'); 
    ...
    {
        Schema::dropIfExists('d_api12002_adp');
    }
};
