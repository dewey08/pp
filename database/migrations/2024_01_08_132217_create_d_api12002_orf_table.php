...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_api12002_orf'))
        {
            Schema::create('d_api12002_orf', function (Blueprint $table) {
                $table->bigIncrements('d_api12002_orf_id'); 
    ...
    {
        Schema::dropIfExists('d_api12002_orf');
    }
};
