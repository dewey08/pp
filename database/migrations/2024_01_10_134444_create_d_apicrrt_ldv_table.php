...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apicrrt_ldv'))
        {
            Schema::create('d_apicrrt_ldv', function (Blueprint $table) {
                $table->bigIncrements('d_apicrrt_ldv_id'); 
    ...
    {
        Schema::dropIfExists('d_apicrrt_ldv');
    }
};
