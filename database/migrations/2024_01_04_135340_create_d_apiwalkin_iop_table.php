...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apiwalkin_iop'))
        {
            Schema::create('d_apiwalkin_iop', function (Blueprint $table) {
                $table->bigIncrements('d_apiwalkin_iop_id'); 
    ...
    {
        Schema::dropIfExists('d_apiwalkin_iop');
    }
};
