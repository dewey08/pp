...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apicrrt_dru'))
        {
            Schema::create('d_apicrrt_dru', function (Blueprint $table) {
                $table->bigIncrements('d_apicrrt_dru_id'); 
    ...
    {
        Schema::dropIfExists('d_apicrrt_dru');
    }
};
