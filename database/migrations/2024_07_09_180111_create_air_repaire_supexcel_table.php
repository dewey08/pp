...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('air_repaire_supexcel'))
        {
            Schema::create('air_repaire_supexcel', function (Blueprint $table) {
                $table->bigIncrements('air_repaire_supexcel_id');
    ...
    {
        Schema::dropIfExists('air_repaire_supexcel');
    }
};
