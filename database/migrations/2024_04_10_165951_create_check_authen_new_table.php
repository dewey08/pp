...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('check_authen_new'))
        {
        Schema::create('check_authen_new', function (Blueprint $table) {
            $table->bigIncrements('check_authen_new_id');
    ...
    {
        Schema::dropIfExists('check_authen_new');
    }
};
