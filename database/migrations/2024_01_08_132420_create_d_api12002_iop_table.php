...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_api12002_iop'))
        {
            Schema::create('d_api12002_iop', function (Blueprint $table) {
                $table->bigIncrements('d_api12002_iop_id'); 
    ...
    {
        Schema::dropIfExists('d_api12002_iop');
    }
};
