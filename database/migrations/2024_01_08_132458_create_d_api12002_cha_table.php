...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_api12002_cha'))
        {
            Schema::create('d_api12002_cha', function (Blueprint $table) {
                $table->bigIncrements('d_api12002_cha_id'); 
    ...
    {
        Schema::dropIfExists('d_api12002_cha');
    }
};
