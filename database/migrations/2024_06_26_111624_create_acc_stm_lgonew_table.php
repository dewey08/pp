...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('acc_stm_lgonew'))
        {
            Schema::create('acc_stm_lgonew', function (Blueprint $table) {
                $table->bigIncrements('acc_stm_lgonew_id');  
    ...
    {
        Schema::dropIfExists('acc_stm_lgonew');
    }
};
