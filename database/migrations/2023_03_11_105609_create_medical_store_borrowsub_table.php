...
return new class extends Migration
{
    ...
    public function up()
    { 
        if (!Schema::hasTable('medical_store_borrowsub'))
        {
            Schema::connection('mysql')->create('medical_store_borrowsub', function (Blueprint $table) {
                $table->bigIncrements('medical_store_borrowsub_id'); 
                $table->string('medical_store_borrow_id',100)->nullable();// 
    ...
    {
        Schema::dropIfExists('medical_store_borrowsub');
    }
};
