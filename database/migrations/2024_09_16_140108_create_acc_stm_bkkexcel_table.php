...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('acc_stm_bkkexcel'))
        {
            Schema::connection('mysql')->create('acc_stm_bkkexcel', function (Blueprint $table) {
                $table->bigIncrements('acc_stm_bkkexcel_id'); 
    ...
    {
        Schema::dropIfExists('acc_stm_bkkexcel');
    }
};
