...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apicrrt_iop'))
        {
            Schema::create('d_apicrrt_iop', function (Blueprint $table) {
                $table->bigIncrements('d_apicrrt_iop_id'); 
    ...
    {
        Schema::dropIfExists('d_apicrrt_iop');
    }
};
