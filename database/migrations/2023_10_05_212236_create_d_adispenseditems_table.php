...
return new class extends Migration
{
    ...
    public function up()
    { 
        if (!Schema::hasTable('d_adispenseditems'))
        {
            Schema::connection('mysql')->create('d_adispenseditems', function (Blueprint $table) {
                $table->bigIncrements('d_adispenseditems_id');
    ...
    {
        Schema::dropIfExists('d_adispenseditems');
    }
};
