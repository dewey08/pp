...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apicrrt_aer'))
        {
            Schema::create('d_apicrrt_aer', function (Blueprint $table) {
                $table->bigIncrements('d_apicrrt_aer_id'); 
    ...
    {
        Schema::dropIfExists('d_apicrrt_aer');
    }
};
