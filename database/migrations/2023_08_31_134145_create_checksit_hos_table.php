...
return new class extends Migration
{
    ...
    public function up()
    { 
        if (!Schema::hasTable('checksit_hos'))
        { 
            Schema::connection('mysql')->create('checksit_hos', function (Blueprint $table) {
                $table->bigIncrements('checksit_hos_id'); 
    ...
    {
        Schema::dropIfExists('checksit_hos');
    }
};
