...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_fdh_rep'))
        {
            Schema::connection('mysql')->create('d_fdh_rep', function (Blueprint $table) { 
                $table->bigIncrements('d_fdh_rep_id');//  
