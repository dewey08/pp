...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_api12002_opd'))
        {
            Schema::create('d_api12002_opd', function (Blueprint $table) {
                $table->bigIncrements('d_api12002_opd_id'); 
    ...
    {
        Schema::dropIfExists('d_api12002_opd');
    }
};
