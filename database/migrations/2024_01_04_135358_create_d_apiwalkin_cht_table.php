...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apiwalkin_cht'))
        {
            Schema::create('d_apiwalkin_cht', function (Blueprint $table) {
                $table->bigIncrements('d_apiwalkin_cht_id'); 
    ...
    {
        Schema::dropIfExists('d_apiwalkin_cht');
    }
};
