...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apiwalkin_idx'))
        {
            Schema::create('d_apiwalkin_idx', function (Blueprint $table) {
                $table->bigIncrements('d_apiwalkin_idx_id'); 
    ...
    {
        Schema::dropIfExists('d_apiwalkin_idx');
    }
};
