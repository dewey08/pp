...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apiwalkin_irf'))
        {
            Schema::create('d_apiwalkin_irf', function (Blueprint $table) {
                $table->bigIncrements('d_apiwalkin_irf_id'); 
    ...
    {
        Schema::dropIfExists('d_apiwalkin_irf');
    }
};
