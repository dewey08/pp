...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_api12002_ipd'))
        {
            Schema::create('d_api12002_ipd', function (Blueprint $table) {
                $table->bigIncrements('d_api12002_ipd_id'); 
    ...
    {
        Schema::dropIfExists('d_api12002_ipd');
    }
};
