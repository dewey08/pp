...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_api12002_idx'))
        {
            Schema::create('d_api12002_idx', function (Blueprint $table) {
                $table->bigIncrements('d_api12002_idx_id'); 
    ...
    {
        Schema::dropIfExists('d_api12002_idx');
    }
};
