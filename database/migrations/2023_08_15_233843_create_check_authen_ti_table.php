...
return new class extends Migration
{
    ...
    public function up()
    { 
        if (!Schema::hasTable('check_authen_ti'))
        {
        Schema::create('check_authen_ti', function (Blueprint $table) {
            $table->bigIncrements('check_authen_ti_id');  
    ...
    {
        Schema::dropIfExists('check_authen_ti');
    }
};
