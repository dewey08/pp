...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apicrrt_cht'))
        {
            Schema::create('d_apicrrt_cht', function (Blueprint $table) {
                $table->bigIncrements('d_apicrrt_cht_id'); 
    ...
    {
        Schema::dropIfExists('d_apicrrt_cht');
    }
};
