...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('acc_1102050101_303'))
        {
            Schema::create('acc_1102050101_303', function (Blueprint $table) {
                $table->bigIncrements('acc_1102050101_303_id'); 
    ...
    {
        Schema::dropIfExists('acc_1102050101_303');
    }
};
