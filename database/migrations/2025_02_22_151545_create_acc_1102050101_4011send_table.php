...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('acc_1102050101_4011send'))
        {
            Schema::create('acc_1102050101_4011send', function (Blueprint $table) {
                $table->bigIncrements('acc_1102050101_4011send_id');
    ...
    {
        Schema::dropIfExists('acc_1102050101_4011send');
    }
};
