...
return new class extends Migration
{
    ...
    public function up()
    { 
        if (!Schema::hasTable('acc_1102050102_107'))
        {
            Schema::create('acc_1102050102_107', function (Blueprint $table) {
                $table->bigIncrements('acc_1102050102_107_id');
    ...
    {
        Schema::dropIfExists('acc_1102050102_107');
    }
};
