...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apicrrt_ipd'))
        {
            Schema::create('d_apicrrt_ipd', function (Blueprint $table) {
                $table->bigIncrements('d_apicrrt_ipd_id'); 
    ...
    {
        Schema::dropIfExists('d_apicrrt_ipd');
    }
};
