...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_api12002_irf'))
        {
            Schema::create('d_api12002_irf', function (Blueprint $table) {
                $table->bigIncrements('d_api12002_irf_id'); 
    ...
    {
        Schema::dropIfExists('d_api12002_irf');
    }
};
