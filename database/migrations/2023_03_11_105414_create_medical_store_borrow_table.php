...
return new class extends Migration
{
    ...
    public function up()
    { 
        if (!Schema::hasTable('medical_store_borrow'))
        {
            Schema::connection('mysql')->create('medical_store_borrow', function (Blueprint $table) {
                $table->bigIncrements('medical_store_borrow_id'); 
    ...
    {
        Schema::dropIfExists('medical_store_borrow');
    }
};
