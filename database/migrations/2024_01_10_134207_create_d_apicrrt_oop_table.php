...
return new class extends Migration
{
    ...
    { 
        if (!Schema::hasTable('d_apicrrt_oop'))
        {
            Schema::create('d_apicrrt_oop', function (Blueprint $table) {
                $table->bigIncrements('d_apicrrt_oop_id'); 
    ...
    {
        Schema::dropIfExists('d_apicrrt_oop');
    }
};
