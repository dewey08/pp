...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  $s_in_pst = "INSERT INTO $database_ii.pang_stamp_temp
            ...
            \t  ,CONCAT(cs.check_sit_subinscl,' (',IFNULL(cs.check_sit_hmain,''),') ',cs.check_sit_date ) 
              ...
              ,v.pdx AS icd
              ,$show_adjrw
              ,ROUND(v.income,2) AS 'income'
              ,$select_uc_money AS 'uc_moneyx'
              ,ROUND(v.paid_money,2) AS 'paid_money'
                    ...
                    <table id="example" class="table table-striped table-hover"   >
                      ...
                      $no++;
                        ...
                        <tr>
                          ...
                          // && $row_show["$if_rw"]!=0 
                          if($row_show["pttype_stamp"]!='' && $uc_money!='' && $uc_money>0 ){
                          ?>
                          <!--0-->
                          <td>
                            <input type="checkbox" name="vn[]" value="<?php echo $view_income_vn_or_an.$uc_money.'|'.@$uc_money_kor_tok.'|'.@$row_show['rw']?>" >
