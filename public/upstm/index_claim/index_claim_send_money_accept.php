...
<html>
  ...
  <?php
            if(isset($_POST["sir_pang_stamp_send"]) ){
              ...
              $where_sir_pang_stamp_send = "WHERE pss.money_receive_date IS NOT NULL AND pss.pang_stamp_send_year = '$y_s' "; 
            }
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body"> 
          ...
          <h2>รายการส่งลูกหนี้ ที่การเงินลงรับเอกสารลูกหนี้แล้ว</h2>  
