...
class Account501Controller extends Controller
 {
    ...
    public function account_501_dash_(Request $request)
    {
    ...
    public function account_501_dash(Request $request)
    {
        ...
        // dd($startdate);
        return view('account_501.account_501_dash',$data,[
            'startdate'         =>  $startdate,
            'enddate'           =>  $enddate,
            'leave_month_year'  =>  $leave_month_year,
            'datashow'          =>  $datashow,
    ...
    public function account_501_checksit(Request $request)
    {
    ...
    public function account_501_pulldata(Request $request)
    {
        ...
        $acc_debtor = DB::connection('mysql2')->select('
                ...
                AND vp.pttype IN(SELECT pttype FROM pkbackoffice.acc_setpang_type WHERE pang ="1102050101.501" AND opdipd = "OPD" AND pttype IS NOT NULL)
        ...
        foreach ($acc_debtor as $key => $value) {
                    $check = Acc_debtor::where('vn', $value->vn)->where('account_code','1102050101.501')->count();
                    if ($check == 0) {
                        Acc_debtor::insert([
                            'hn'                 => $value->hn,
                            'an'                 => $value->an,
