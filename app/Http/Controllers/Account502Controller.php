...
class Account502Controller extends Controller
 {
    ...
    public function account_502_dash(Request $request)
    {
        ...
        // dd($startdate);
        return view('account_502.account_502_dash',$data,[
            'startdate'         =>  $startdate,
            'enddate'           =>  $enddate,
            'leave_month_year'  =>  $leave_month_year,
            'datashow'          =>  $datashow,
    ...
    public function account_502_pull(Request $request)
    {
        ...
        if ($startdate == '') {
            $acc_debtor = DB::select(
                'SELECT a.*
                from acc_debtor a
                WHERE a.account_code="1102050101.502" AND a.dchdate BETWEEN "' . $newday . '" AND "' . $datenow . '"
            ...
            $acc_debtor = DB::select(
                'SELECT a.*
                from acc_debtor a
                WHERE a.account_code="1102050101.502" AND a.dchdate BETWEEN "' . $startdate . '" AND "' . $enddate . '"
    ...
    public function account_502_checksit(Request $request)
    {
