        ...
        $enddate = $request->datepicker2; 
            $acc_debtor = DB::connection('mysql2')->select(
                'SELECT * FROM
                        ...
                        ,case
                        when (v.income-(SELECT SUM(ot.sum_price) FROM opitemrece ot LEFT JOIN xray_items xr ON xr.icode = ot.icode WHERE ot.vn =v.vn AND ot.income ="08" AND xr.xray_items_group ="3")+(SELECT SUM(sum_price) FROM opitemrece WHERE vn =v.vn AND income <>"08")) < 1000 then (v.income-(SELECT SUM(ot.sum_price) FROM opitemrece ot LEFT JOIN xray_items xr ON xr.icode = ot.icode WHERE ot.vn =v.vn AND ot.income ="08" AND xr.xray_items_group ="3")+(SELECT SUM(sum_price) FROM opitemrece WHERE vn =v.vn AND income <>"08"))
                        ...
                        ,case
                        when (v.income-(SELECT SUM(ot.sum_price) FROM opitemrece ot LEFT JOIN xray_items xr ON xr.icode = ot.icode WHERE ot.vn =v.vn AND ot.income ="08" AND xr.xray_items_group ="3")+(SELECT SUM(sum_price) FROM opitemrece WHERE vn =v.vn AND income <>"08")) < 700 then (v.income-(SELECT SUM(ot.sum_price) FROM opitemrece ot LEFT JOIN xray_items xr ON xr.icode = ot.icode WHERE ot.vn =v.vn AND ot.income ="08" AND xr.xray_items_group ="3")+(SELECT SUM(sum_price) FROM opitemrece WHERE vn =v.vn AND income <>"08"))
                        when v.uc_money < 1000 then v.uc_money
                        else "700"
                        end as toklong
