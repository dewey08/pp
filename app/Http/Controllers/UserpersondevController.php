...
class UserpersondevController extends Controller
{  
...
public function persondev_dashboard(Request $request)
{   
    ...
    return view('user.persondev_dashboard',$data);
}

public function persondev_index(Request $request)
{   
    $data['q'] = $request->query('q');
    $query = User::select('users.*')
    ->where(function ($query) use ($data){
    ...
    return view('user.persondev_index',$data);
}
public function persondev_inside(Request $request)
{   
    $data['q'] = $request->query('q');
    $query = User::select('users.*')
    ->where(function ($query) use ($data){
    ...
    return view('user.persondev_inside',$data);
}
