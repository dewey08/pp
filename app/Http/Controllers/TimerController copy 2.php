...
class TimerController extends Controller
{
    ...
    public function time_depsubsub_excel_new(Request $request)
    {
        ...
        //         ORDER BY c.CHEACKIN_DATE,d.HR_DEPARTMENT_SUB_SUB_ID,p.ID,ot.OPERATE_TYPE_ID
        // ');
        $export = DB::connection('mysql')->select('SELECT * FROM operate_time_dss');
        $iduser              = Auth::user()->id;
        $deb                 = Auth::user()->dep_subsubtrueid;
        // $iduser              = Auth::user()->id;
        // $debsubsubname_ = DB::connection('mysql6')->table('hrd_department_sub_sub')->where('HR_DEPARTMENT_SUB_SUB_ID', '=', $deb)->first();
        // $dap            = $debsubsubname_->HR_DEPARTMENT_SUB_SUB_NAME;
        ...
        // $debsubsubname_ = Operate_time_dss::where('user_id', '=', $iduser)->where('operate_time_dss_dssid', '=', $deb)->get();
        // // dd($debsubsubname_);
        // foreach ($debsubsubname_ as $key => $value) {
        //     $dap        = $value->operate_time_dss_dss;
        // }
        // dd($dap);
        // $dap            = $debsubsubname_->HR_DEPARTMENT_SUB_SUB_NAME;
