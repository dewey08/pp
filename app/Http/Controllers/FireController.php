...
class FireController extends Controller
 {
        ...
        // Narmal
            ...
            // ');
             $datareport = DB::connection('mysql')->select(
                'SELECT a.months,a.years,a.years_th as yearsthai,b.month_name
                ,a.total_backup_r10,a.total_backup_r15,a.total_backup_r20
                ,a.total_red10,a.total_red15,a.total_red20,a.total_green10,a.total_all_qty,a.years_th
                FROM fire_stock_month a
                LEFT JOIN months b ON b.month_id = a.months
                WHERE a.bg_yearnow = "'.$bg_yearnow.'"
                GROUP BY a.months
                ORDER BY a.fire_stock_month_id DESC
            ');
    ...
    public function fire_stock_month(Request $request)
    {
        ...
        $data['fire_stock_month'] = DB::select('SELECT a.* FROM fire_stock_month a LEFT JOIN months b ON b.month_id = a.months ORDER BY a.fire_stock_month_id DESC');
    ...
    public function fire_report_month_pdf(Request $request)
    {
        $startdate     = $request->startdate;
        $enddate       = $request->enddate;
        $date_now      = date('Y-m-d');
        ...
        return view('support_prs.fire.fire_report_month_pdf',$data,[
            'startdate'     => $startdate,
            'enddate'       => $enddate,
            'datashow'      => $datashow,
            'month_id'      => $month_id_,
    ...
    public function fire_stock_month_ypkyodauto(Request $request)
    {
        ...
        $dataget         = DB::select(
            'SELECT COUNT(DISTINCT fire_num) as total_all_qty
            ,(SELECT COUNT(DISTINCT fire_num) FROM fire WHERE active = "Y" AND fire_backup = "Y" AND fire_color = "red" AND fire_size = "10") as total_backup_r10
            ,(SELECT COUNT(DISTINCT fire_num) FROM fire WHERE active = "Y" AND fire_backup = "Y" AND fire_color = "red" AND fire_size = "15") as total_backup_r15
            ,(SELECT COUNT(DISTINCT fire_num) FROM fire WHERE active = "Y" AND fire_backup = "Y" AND fire_color = "red" AND fire_size = "20") as total_backup_r20
            ,(SELECT COUNT(DISTINCT fire_num) FROM fire WHERE active = "Y" AND fire_backup = "Y" AND fire_color = "green" AND fire_size = "10") as total_backup_g10
            ,(SELECT COUNT(DISTINCT fire_num) FROM fire WHERE active = "Y" AND fire_backup = "Y" AND fire_color = "green" AND fire_size = "15") as total_backup_g15
            ,(SELECT COUNT(DISTINCT fire_num) FROM fire WHERE active = "Y" AND fire_backup = "Y" AND fire_color = "green" AND fire_size = "20") as total_backup_g20

            ,(SELECT COUNT(DISTINCT fire_num) FROM fire WHERE active = "Y" AND fire_backup = "N" AND fire_color = "red" AND fire_size = "10") as total_red10
            ,(SELECT COUNT(DISTINCT fire_num) FROM fire WHERE active = "Y" AND fire_backup = "N" AND fire_color = "red" AND fire_size = "15") as total_red15
            ,(SELECT COUNT(DISTINCT fire_num) FROM fire WHERE active = "Y" AND fire_backup = "N" AND fire_color = "red" AND fire_size = "20") as total_red20
            ,(SELECT COUNT(DISTINCT fire_num) FROM fire WHERE active = "Y" AND fire_backup = "N" AND fire_color = "green" AND fire_size = "10") as total_green10
            ,(SELECT COUNT(DISTINCT fire_num) FROM fire WHERE active = "Y" AND fire_backup = "N" AND fire_color = "green" AND fire_size = "15") as total_green15
            ,(SELECT COUNT(DISTINCT fire_num) FROM fire WHERE active = "Y" AND fire_backup = "N" AND fire_color = "green" AND fire_size = "20") as total_green20
            FROM fire WHERE active = "Y"
    ...
    public function fire_stock(Request $request)
    {
        ...
        if ($startdate =='') {
            ...
            $data['wh_recieve']         = DB::select(
                ...
                LEFT JOIN air_supplies a ON a.air_supplies_id = r.vendor_id
                LEFT JOIN users u ON u.id = r.user_recieve
                WHERE r.recieve_date BETWEEN "'.$startdate.'" AND "'.$enddate.'"
                AND s.stock_list_id = "11"
                ORDER BY wh_recieve_id DESC
            ');
        }
    ...
    public function fire_stock_addsub_update(Request $request)
    {
        $id              = $request->wh_recieve_id;
        ...
        foreach ($getdate as $key => $value) {
            ...
            $pro            = Fire::where('fire_id',$value->pro_id)->first();
            $pro_id         = $pro->fire_id;
            $pro_code       = $pro->fire_num;
            $pro_name       = $pro->fire_name;
