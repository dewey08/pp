...
class AccountIMCController extends Controller
 {
    ...
    public function kontoon_imc_pulldata(Request $request)
    {
        ...
        $acc_debtor = DB::connection('mysql2')->select(
            'SELECT v.vn,ifnull(o.an,"") as an,o.hn,pt.cid ,concat(pt.pname,pt.fname," ",pt.lname) as ptname ,v.vstdate,v.hospmain,v.pdx,vp.claim_code,vp.auth_code
                ,vp.pttype ,"" as acc_code ,"4301020105.228" as account_code ,"บริการฟื้นฟูสมรรถภาพด้านการแพทย์/IMC" as account_name,o.main_dep
                ...
                AND op.income ="14" AND ptt.hipdata_code ="UCS"
