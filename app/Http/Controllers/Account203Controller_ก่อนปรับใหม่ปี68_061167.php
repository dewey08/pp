...
class Account203Controller extends Controller
 {
    ...
    public function account_203_pulldata(Request $request)
    {
        ...
        $data_w1 = DB::connection('mysql2')->select('SELECT vn FROM vn_stat WHERE pttype IN("W1","W2") AND hospmain IN("10970","10971","10972","10973","10974","10975","10976","10977","10702","10979","10980","10981","10983","","","",)');
