...
class Account310Controller extends Controller
 { 
    ...
    public function account_310_pull(Request $request)
    {
        ...
        if ($startdate == '') {
            ...
            $acc_debtor = DB::select('
                ...
                SELECT a.acc_debtor_id,a.vn,a.an,a.hn,a.cid,a.ptname,a.vstdate,a.pttype,a.debit_total,a.subinscl,a.dchdate ,a.debit
            ...
            ');
            // a.*,c.subinscl     left join checksit_hos c on c.an = a.an
    ...
    public function account_310_checksit(Request $request)
    {
        $datestart = $request->datestart;
        $dateend = $request->dateend;
        $date = date('Y-m-d');
        
        $data_sitss = DB::connection('mysql')->select('SELECT vn,an,cid,vstdate,dchdate FROM acc_debtor WHERE account_code="1102050101.310" AND stamp = "N" GROUP BY an');
