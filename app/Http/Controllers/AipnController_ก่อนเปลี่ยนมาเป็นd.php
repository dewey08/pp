...
class AipnController extends Controller
{
    ...
    public function aipn_send_an(Request $request)
    {
        ...
        $dateend = $request->enddate; 
        // $an = $request->AN;
        $an_ = Aipn_ipadt::where('aipn_ipadt_id','=',1)->first();
        $an = $an_->AN;
        $ip = $request->ip(); 
        // dd($an);
       ...
       #delete file in folder ทั้งหมด
        ...
        $add->save();
         ...
         $url = "http://192.168.0.17/pkclaim/public";
         $part_ = pathinfo($url);

         $desPath = 'Export_Claim';
        // $myimage = $folders->getClientOriginalName();
        // $move_file = $folder->move(public_path($desPath));
        // $foldertxts->move(public_path($desPath), $foldertxt);

        // dd($move_file);
        // mkdir ($desPath.'/'.$folder, 0777, true);
        // mkdir ($desPath.'/'.$foldertxt, 0777, true);
        mkdir ('C:/Export_Claim/'.$folder, 0777, true);
        mkdir ('C:/Export_Claim/'.$foldertxt, 0777, true);
        ...
        // $file_pat = $desPath.'/'.$foldertxt."/10978-AIPN-".$an.'-'.$aipn_date_now_preg.''.$aipn_time_now_preg.".txt";  
        $file_pat = "C:/Export_Claim/".$foldertxt."/10978-AIPN-".$an.'-'.$aipn_date_now_preg.''.$aipn_time_now_preg.".txt";    
        $objFopen_opd = fopen($file_pat, 'w');
        // dd($file_pat);
        ...
        // $file_pat2 = $desPath.'/'.$folder."/10978-AIPN-".$an.'-'.$aipn_date_now_preg.''.$aipn_time_now_preg.".xml";  
        $file_pat2 = "C:/Export_Claim/".$folder."/10978-AIPN-".$an.'-'.$aipn_date_now_preg.''.$aipn_time_now_preg.".xml";     
        $objFopen_opd2 = fopen($file_pat2, 'w');
    ...
    public function aipn_send_all(Request $request)
    {
        $datestart = $request->startdate;
        $dateend = $request->enddate; 
        // $an = $request->AN;
    ...
    {    
        ...
        // $desPath = "Export_Claim";
        $pathdir = "C:/Export_Claim/".$namezip."/";
        // $pathdir = $desPath."/".$namezip."/";
    ...
    public function aipn_equipdev(Request $request)
    {
        $datestart = $request->startdate;
        $dateend = $request->enddate;
        $an = $request->AN;
        if ($an != '') {
            $aipn_data = DB::connection('mysql3')->select('   
                SELECT
                        ...
                        ,inc.income as BillGrCS 
                        ,ifnull(if(inc.income in (02),dd.billcode,d.nhso_adp_code),"") as CSCode
			            ,"" as STDCode
                        ,"" as CodeSys 
                        ,oo.icode as LCCode
        ...
        //         ,ifnull(if(inc.income in (03,04),"TMT","TMLT"),"") as CodeSys 
            ...
            foreach ($aipn_data as $key => $value) {     
                ...
                foreach ($aipn_billitems as $key => $value2) { 
                    ...
                    $cs_ = $value2->BillGrCS;
                    $cs = $value2->CSCode;
                    $cma_ = $value2->ClaimCat;  
                        
                    if ($cma_ == 'T') {
                        $cml = $value2->QTY * $value2->pricehos;
                    } else {
                        $cml = $value2->ClaimAmt;
                    }
            ...
            $aipn_data = DB::connection('mysql3')->select('   
                SELECT
                    ...
                    left join ovst ov on ov.an=i.an 
                    WHERE i.dchdate BETWEEN "'.$datestart .'"  AND "'.$dateend .'"                    
                    AND ptt.pttype = "A7" and inc.income="02"
                    group by i.an
                    order by hn
            ');
            Aipn_ipadt::truncate();
        ...
        return view('claim.aipn_equipdev',[
            'start'                => $datestart,
            'end'                  => $dateend,
            'aipn_data'            => $aipn_data,
            'aipn_billitems'       => $aipn_billitems,
    ...
    public function aipn_equipdevsearch (Request $request)
    {
        $datestart = $request->startdate;
        $dateend = $request->enddate;
        $an = $request->AN;
    ...
    public function checkdata (Request $request)
    {
        ...
        $aipn_data = DB::connection('mysql3')->select(' 
            SELECT
                    ...
                    left join claim.aipn_drugcat_labcat dd on dd.icode=oo.icode	
                    left join ovst ov on ov.an=i.an 
                    left join claim.stm st on st.AN=i.an 
                    WHERE st.AN = "'.$an .'"    
        ');
        // $aipn_data = DB::connection('mysql7')->select('   
        //     SELECT * FROM aipn_ipadt 
    ...
    public function aipn_disability (Request $request)
    {
        $datestart = $request->startdate;
        $dateend = $request->enddate;
        $an = $request->AN;
        ...
        return view('claim.aipn_disability',[
            'start'            => $datestart,
            'end'              => $dateend,
            'aipn_data'        => $aipn_data,
            'aipn_billitems'   => $aipn_billitems,
    ...
    public function aipn_disability_search (Request $request)
    {
        $datestart = $request->startdate;
        $dateend = $request->enddate;
        $an = $request->AN;
    ...
    public function aipn_disability_an (Request $request)
    {
        $datestart = $request->startdate;
        $dateend = $request->enddate;
        $an = $request->AN;
    ...
    public function aipn_plb(Request $request)
    {
        $datestart = $request->startdate;
        $dateend = $request->enddate;
        $an = $request->AN;
        ...
        return view('claim.aipn_plb',$data,[
            'start'                => $datestart,
            'end'                  => $dateend,
            'aipn_data'            => $aipn_data,
            'aipn_billitems'       => $aipn_billitems,
    ...
    public function aipn_plb_search (Request $request)
    {
        $datestart = $request->startdate;
        $dateend = $request->enddate;
        $an = $request->AN;
    ...
    public function aipn_plb_send_anplb(Request $request)
    {
        $datestart = $request->startdate;
        $dateend = $request->enddate; 
        // $an = $request->AN;
       ...
       #delete file in folder ทั้งหมด
        ...
        fclose($objFopen_opd2); 
            ...
            return redirect()->route('claim.aipn_plb',[
                'an'  => $an
            ]);      
