...
{   
    ...
    return view('user.house_detail',$data);
}

public function house_petition(Request $request)
{   
    $data['q'] = $request->query('q');
    $query = User::select('users.*')
    ->where(function ($query) use ($data){
    ...
    return view('user.house_petition',$data);
}
public function house_problem(Request $request)
{   
    $data['q'] = $request->query('q');
    $query = User::select('users.*')
    ->where(function ($query) use ($data){
    ...
    return view('user.house_problem',$data);
}
