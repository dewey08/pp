  ...
  .btn{
   ...
   .page{
    ...
    <div class="px-3 py-2 border-bottom">
        ...
        <a href="{{url('rong/rong_storeindex/'.Auth::user()->id)}}" class="btn btn-secondary btn-sm text-white me-2 mt-2">&nbsp;&nbsp;คลังวัสดุ<span class="badge bg-danger ms-2">0</span>&nbsp;&nbsp;</a> 
        <div class="text-end"> 
        </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                  ...
                  <div class="d-flex">
                      <div class="p-2">{{ __('รายการคลังวัสดุ') }}
                      </div> 
