                            ...
                            <div class="fpdf mt-2 text-center" id="pages">            
                                    ...
                                    @else                               
                                      <!-- <iframe src="{{ asset('storage/bookrep_pdf/'.$dataedits->bookrep_file) }}" height="100%" width="100%"></iframe> --> 
                                        <iframe src="{{ url('rong/rong_bookindex_printdetail/'.$dataedits->bookrep_id) }}" height="100%" width="100%"></iframe>                                      
                                    @endif                            
                              </div>                       
                    </div>
                  
                    <div class="col-md-6" > 
                            <form class="custom-validation" action="{{ route('rong.bookmake_retirerong') }}" method="POST" id="signature_retireForm" enctype="multipart/form-data">
                                @csrf
