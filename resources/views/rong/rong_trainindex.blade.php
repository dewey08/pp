  ...
  .btn{
   ...
   .page{
    ...
    <div class="px-3 py-2 border-bottom">
        ...
        <a href="{{url('rong/rong_trainindex/'.Auth::user()->id)}}" class="btn btn-secondary btn-sm text-white me-2 mt-2">ประชุม/อบรม/ดูงาน<span class="badge bg-danger ms-2">0</span></a> 
