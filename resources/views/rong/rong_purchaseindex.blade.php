  ...
  .btn{
   ...
   .page{
    ...
    <div class="px-3 py-2 border-bottom">
        ...
        <a href="{{url('rong/rong_bookindex/'.Auth::user()->id)}}" class="btn btn-light btn-sm text-dark me-2 mt-2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;หนังสือราชการ<span class="badge bg-danger ms-2">{{$count_bookrep_rong}}</span>&nbsp;&nbsp;&nbsp;</a>   
        ...
        <a href="{{url('rong/rong_purchaseindex/'.Auth::user()->id)}}" class="btn btn-secondary btn-sm text-white me-2 mt-2">&nbsp;จัดซื้อจัดจ้าง<span class="badge bg-danger ms-2">{{$count_suprephn}}</span>&nbsp;</a> 
                  ...
                  <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex">
                                <div class="p-2">{{ __('จัดซื้อ-จัดจ้าง') }}
                                </div> 
