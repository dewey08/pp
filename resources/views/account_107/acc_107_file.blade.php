...
@section('content')
    ...
    <div class="tabs-animation">
        ...
        <form action="{{ URL('acc_107_file') }}" method="GET">
            @csrf
        <div class="row">
            <div class="col-md-4">
                <h5 class="card-title" style="color:rgb(248, 28, 83)">Detail Attach File 1102050102.107</h5>
                <p class="card-title-desc">รายละเอียดข้อมูล แนบไฟล์ 1102050102.107</p>
            </div>
            <div class="col"></div>
                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item)
                                    ...
                                    <td class="text-center" width="10%" >
                                        ...
                                        @else
                                        <button type="button" class="btn-icon btn-shadow btn-dashed btn btn-sm btn-outline-warning" data-bs-toggle="modal" data-bs-target="#FileModalshow{{ $item->acc_1102050102_107_id }}">
                                            <img src="{{ asset('storage/account_107/'.$item->filename) }}" height="18px;" width="18px" ></img>
                                        </button>
                                        @endif
                                    </td>
