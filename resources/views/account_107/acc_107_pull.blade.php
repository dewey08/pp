...
@section('content')
    ...
    <div class="tabs-animation">
        ...
        <form action="{{ URL('acc_107_pull') }}" method="GET">
            @csrf
        <div class="row">
            <div class="col-md-4">
                <h4 class="card-title" style="color:rgb(248, 28, 83)">Detail Account ผัง 1102050102.107</h4>
                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            ...
                            <div class="col-md-2 text-end">
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-sm btn-primary cardacc Savestamp" data-url="{{url('acc_107_stam')}}">
                                    <i class="fa-solid fa-file-waveform me-2"></i>
                                    ตั้งลูกหนี้
                                </button>
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-sm btn-danger cardacc Destroystamp" data-url="{{url('account_107_destroy')}}">
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-sm table-striped table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        @foreach ($acc_debtor as $item)
                                            <tr id="tr_{{$item->acc_debtor_id}}">
                                                ...
                                                <td class="text-start" width="5%">
                                                    @if ($item->stamp =='N')
                                                    <img src="{{ asset('images/Cancel_new2.png') }}" height="21px" width="21px">
                                                    @else
                                                    <img src="{{ asset('images/check_trueinfo3.png') }}" height="21px" width="21px">
                                                    @endif
                                                </td>
                                                ...
                                                <td class="text-center" width="10%" style="color: #0973b9">{{ number_format($item->debit_total, 2) }}</td>
                                            </tr>
                                            <?php
                                    ...
                                    <tr style="background-color: #f3fca1">
                                        ...
                                        <td class="text-center" style="background-color: #44E952"><label for="" style="color: #0973b9">{{ number_format($total1, 2) }}</label> </td>
