                            ...
                            <tbody>
                                ...
                                @endforeach  
                                        ...
                                        <tr style="background-color: #f3fca1">
                                            ...
                                            <td class="text-end" style="background-color: #f58d73;color:rgb(0, 0, 0)">{{ number_format($total1,2)}}</td> 
                                            <td class="text-end" style="background-color: #f58d73;color:rgb(0, 0, 0)">{{ number_format($total2,2)}}</td> 
                                            <td class="text-end" style="background-color: #f58d73;color:rgb(0, 0, 0)">{{ number_format($total3,2)}}</td> 
                                            <td class="text-end" style="background-color: #f58d73;color:rgb(0, 0, 0)">{{ number_format($total4,2)}}</td>                                             
                                            {{-- <td class="text-end" style="background-color: #ace5fc">{{ number_format($total5,2)}}</td>  --}}
                                            <td class="text-end" style="background-color: #e09be9;color:rgb(0, 0, 0)">{{ number_format($total6,2)}}</td> 
                                            <td class="text-end" style="background-color: #f5a382;color:rgb(0, 0, 0)">{{ number_format($total7,2)}}</td> 
                                            <td class="text-end" style="background-color: #047c5e;color:rgb(0, 0, 0)">{{ number_format($total8,2)}}</td>  
