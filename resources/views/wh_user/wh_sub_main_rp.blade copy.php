                                ...
                                {{-- <table id="scroll-vertical-datatable" class="table table-sm table-striped table-bordered nowrap w-100" style="width: 100%;">   --}}
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="background-color: rgb(201, 243, 248);font-size: 12px;" width="5%">จัดการ</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr id="sid{{ $item->wh_request_id }}" style="font-size:12px;">
                                            ...
                                            <td class="text-center" width="5%">
                                                ...
                                                @elseif ($item->active == 'CONFIRM')
                                                    <span class="badge card_prs_4" style="font-size:10px;background-color: #ff568e">รอยืนยันการจ่ายพัสดุ</span>
                                            ...
                                            <td class="text-center" style="color:rgb(4, 115, 180)" width="8%">{{number_format($item->total_price, 2)}}</td>
                                            ...
                                            <td class="text-center" width="10%">
                                                    ...
                                                    @else
                                                        ...
                                                        {{-- <a href="{{url('wh_request_addsubpic/'.$item->wh_request_id)}}" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="เพิ่มวัสดุ(ภาพ)">
                                                            <img src="{{ asset('images/Add_product_pic.png') }}" class="ms-2" height="24px" width="24px">
                                                        </a> --}}
                                                    @endif
