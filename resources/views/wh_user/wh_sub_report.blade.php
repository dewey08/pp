                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end" style="font-size: 12px;color:rgb(235, 9, 95)">
                                                         ...
                                                         @php
                                                            ...
                                                            // $datastock_sub       = DB::select('');
                                                            $stock_repsub       = DB::table('wh_stock_dep_sub')->where('stock_list_subid',$item->stock_list_subid) ->where('pro_id',$item->pro_id)->SUM('qty_pay');
                                                            $stock_paysub       = DB::table('wh_pay_sub')->where('stock_list_subid',$item->stock_list_subid) ->where('pro_id',$item->pro_id)->SUM('qty_pay_sub');

                                                        @endphp
                                                     {{-- {{$item->stock_rep-$item->stock_pay}} --}}
                                                        <td class="text-center" style="font-size: 12px;color:rgb(29, 102, 185)"> {{ $item->request_qty_pay-$item->stock_pay}}</td>
                                                        {{-- <td class="text-center" style="font-size: 12px;color:rgb(29, 102, 185)"> {{ $item->request_qty_pay-$stock_paysub}}</td> --}}
                                                        <td class="text-end" style="font-size: 12px;color:rgb(29, 102, 185)"> {{ $item->one_price}}</td>
                                                        <td class="text-end" style="font-size: 12px;color:rgb(29, 102, 185)">{{ number_format(($item->request_qty_pay-$item->stock_pay)*$item->one_price, 2)}} </td>
                                                        ...
                                                        {{-- <td class="text-end" style="font-size: 12px;color:rgb(29, 102, 185)">{{ number_format(($stock_repsub-$stock_paysub)*$item->one_price, 2)}} </td> --}}
