                ...
                <div class="card card_audit_4c">
                    ...
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item)
                                    ...
                                    <tr>
                                        ...
                                        @else
                                            <td class="text-end" style="color:rgb(7, 189, 149)" width="7%"> {{ number_format($item->stm_money, 2) }}</td>
                                        @endif
                            ...
                            <tr style="background-color: #f3fca1">
                                ...
                                <td class="text-end" style="background-color: #05a77e"><label for="" style="color: #FFFFFF">{{ number_format($total2, 2) }}</label></td> 
