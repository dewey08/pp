        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control-sm d12font input_border" id="stock_list_name" name="stock_list_name" style="width: 100%" placeholder="ชื่อคลังพัสดุ">
                        </div>
                        ...
                        <div class="col-md-2 text-start">
                            {{-- <a href="javascript:void(0);" class="ladda-button btn-pill btn btn-sm btn-primary active_4c" data-bs-toggle="modal" data-bs-target="#Request">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#InsertData').click(function() {
                ...
                $.ajax({
                    url: "{{ route('wh.wh_confix_store_save') }}",
                    type: "POST",
                    dataType: 'json',
                    data: {stock_list_name,userid,userpay},
