    ...
    <div id="preloader">
        ...
        <div class="app-main__outer">
            <div class="app-main__inner">
                ...
                <form action="{{ URL('wh_sub') }}" method="GET">
                    @csrf
                    <div class="row"> 
                        <div class="col"></div>
                        <div class="col-md-7">
                            <h3 style="color:rgb(4, 86, 141)">คลังย่อย</h3>
                            <p style="font-size: 15px">รายละเอียดข้อมูลคลังย่อยทั้งหมด</p>
                        </div> 
                ...
                <div class="row">  
                    <div class="col"></div> 
                        ...
                        <div class="col-xl-10">
                            <div class="card card_audit_4c" style="background-color: rgb(247, 252, 255)">   
                                            ...
                                            @foreach ($wh_stock_list as $item)
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-start" style="font-size: 17px;color:#054d88">
                                                            <a href="{{ url('wh_sub_dep/'.$item->DEPARTMENT_SUB_SUB_ID) }}">{{$item->DEPARTMENT_SUB_SUB_NAME}}</a>
                                                            
                                                        </td>    
                                                        <td class="text-end" style="color:rgb(6, 79, 163)" width="10%"> {{ $item->rec_total_qty}}</td>     
                                                        <td class="text-end" style="color:rgb(6, 79, 163)" width="10%"> {{ number_format($item->rec_total_price, 2) }}</td> 
