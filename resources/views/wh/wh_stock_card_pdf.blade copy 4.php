          ...
          @endif
                            ...
                            @php            
                                    ...
                                    $stock_card_pay   = DB::select(
                                        'SELECT b.pro_id,b.pro_code,b.pro_name,d.wh_unit_name,b.qty_pay,b.lot_no,c.export_date,b.one_price,e.DEPARTMENT_SUB_SUB_NAME,b.stock_list_subid,f.request_no
                                    ...
                                    ');
                                    foreach ($stock_card_pay as $key => $val_count) {
                                            $qty_pay   = $val_count->qty_pay;
                                            $export_date   = $val_count->export_date;
                                        }
                            ...
                            @endphp
                                   ...
                                   <tr style="font-size: 11px;height: 11px;">
                                      ...
                                      {{-- <td style="border: 1px solid black;" class="text-center" >
                                        <table border="0">
                                          @foreach ($stock_card_pay as $item_pay)       
                                              <tr>
                                                  <td style="border: 1px solid black;" class="text-center">&nbsp;</td> 
                                              </tr>
                                              @endforeach   
