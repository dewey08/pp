                    ...
                    <div class="col-md-12">
                        <div class="card card_audit_4c">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    {{-- <div class="col"></div> --}}
                                    <div class="col-md-1 text-end">คลังหลัก</div>
                                    <div class="col-md-3">
                                        <select name="stock_list_id" id="stock_list_id"  class="form-control-sm d12font" style="width: 100%">
                                            ...
                                            @if ($data_edit->stock_list_id==$item_s->stock_list_id)
                                            <option value="{{$item_s->stock_list_id}}" selected>{{$item_s->stock_list_name}}</option>
                                            @else
                                    ...
                                    <div class="col-md-1 text-end">คลังย่อย</div>
                                    <div class="col-md-3">
                                        <select name="stock_list_subid" id="stock_list_subid"  class="form-control-sm d12font" style="width: 100%">
                                            ...
                                            @if ($data_edit->stock_list_subid == $item_sup->DEPARTMENT_SUB_SUB_ID)
                                            <option value="{{$item_sup->DEPARTMENT_SUB_SUB_ID}}" selected>{{$item_sup->DEPARTMENT_SUB_SUB_NAME}}</option>
                                            @else
                                    ...
                                    <div class="col-md-2">
                                        <button type="button" id="UpdatetData" class="ladda-button me-2 btn-pill btn btn-sm btn-success input_new" >
                                            <img src="{{ asset('images/Edit-Pen-Write.png') }}" class="me-2" height="21px" width="21px">
                                           แก้ไขใบตัดจ่ายพัสดุ
                                       </button>
                                    </div>
                                </div>
                ...
                Swal.fire({ position: "top-end",
                        ...
                        confirmButtonText: 'Yes, Edit it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('wh.wh_main_payupdate') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {request_no,request_date,request_time,stock_list_subid,stock_list_id,bg_yearnow,user_request,wh_request_id},
                                    success: function(data) {
                                        if (data.status == 200) {
                                            Swal.fire({ position: "top-end",
