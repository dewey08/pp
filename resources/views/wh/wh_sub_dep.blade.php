                                    ...
                                    <div class="col-xl-12">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-start" width="10%">{{$item->wh_unit_pack_qty}}/{{$item->unit_name}}</td>
                                                    <td class="text-center" width="10%" style="color:rgb(3, 93, 145)">
                                                        @if ($item->stock_rep =='')
                                                            0
                                                        @else
                                                            {{$item->stock_rep}}
                                                    ...
                                                    <td class="text-center" width="10%" style="color:rgb(3, 93, 145)">{{$item->stock_rep-$item->stock_pay}} </td>
                                                    <td class="text-center" width="10%" style="color:rgb(4, 115, 180)">{{number_format($item->sum_stock_price-$item->sum_stock_pricepay, 2)}}</td>
                                            ...
                                            <tr style="background-color: #f3fca1">
                                                ...
                                                <td class="text-center" style="background-color: #276ed8;color: #019765">{{number_format($total6,2)}}</td>
