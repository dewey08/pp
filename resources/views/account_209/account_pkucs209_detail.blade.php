                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <tr style="background-color: #f3fca1">
                                ...
                                <td class="text-center" style="background-color: #44E952"><label for="" style="color: #0c68a5">{{ number_format($total1, 2) }}</label> </td>
                                <td class="text-center" style="background-color: #47A4FA"><label for="" style="color: #0c68a5">{{ number_format($total2, 2) }}</label></td>
                                <td class="text-center" style="background-color: #FCA533" ><label for="" style="color: #0c68a5">{{ number_format($total3, 2) }}</label></td>
                                <td class="text-center" style="background-color: #8340f0"><label for="" style="color: #0c68a5">{{ number_format($total4, 2) }}</label> </td>
                                <td class="text-center" style="background-color: #f08640"><label for="" style="color: #0c68a5">{{ number_format($total5, 2) }}</label> </td>
                            </tr>
                        </table>
                    </div>
                    </div>
