...
@section('content')
    ...
    <div class="tabs-animation">
        ...
        <form action="{{ url('account_pkucs209_pull') }}" method="GET">
            @csrf
        <div class="row ">
            <div class="col-md-4">
                <h5 class="card-title" style="color:rgb(248, 28, 83)">Detail 1102050101.209</h5>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-3 text-end">
                                ...
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-sm btn-primary cardacc Savestamp" data-url="{{url('account_pkucs209_stam')}}">
                                    <i class="fa-solid fa-file-waveform me-2"></i>
                                    ตั้งลูกหนี้
                                </button>
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-sm btn-danger cardacc Destroystamp" data-url="{{url('account_209_destroy')}}">
