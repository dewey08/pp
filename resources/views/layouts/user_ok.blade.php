        ...
        <div class="sidebar">
            ...
            <div class="sidebar-body">
                ...
                <ul class="navigation-list">
                    ...
                    <li
                        class="navigation-list-item {{ 'user/car_dashboard/' . Auth::user()->id == request()->path() ? 'active' : '' }} || {{ 'user/car_narmal/' . Auth::user()->id == request()->path() ? 'active' : '' }} || {{ 'user/car_ambulance/' . Auth::user()->id == request()->path() ? 'active' : '' }}">
                        <a class="navigation-link" href="{{ url('user/car_dashboard/' . Auth::user()->id) }}">
                            <div class="row">
                                <div class="col-2 me-2">
                    ...
                    <li
                        ...
                        <a class="navigation-link"
                            href="{{ url('user_meetting/meetting_dashboard') }}">
                            <div class="row">
                                <div class="col-2 me-2">
