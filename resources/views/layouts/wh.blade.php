...
if (Auth::check()) {
        ...
        $wh_stock_list_only = DB::table('wh_stock_list')->where('stock_type','=','1')->where('active','=','Y')->get();
                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                @php
                                      $data['wh_stock_list'] = DB::table('wh_stock_list')->where('stock_type','=','1')->where('active','=','Y')->get();
                                       $wh_stock_ = DB::select('SELECT * FROM wh_stock_list WHERE stock_type="1" AND active ="Y" ORDER BY stock_list_id ASC');
                                @endphp
                                <div class="dropdown-menu" aria-labelledby="topnav-apps">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-apps" role="button">
                                    <img src="{{ asset('images/wh04.png') }}" height="27px" width="27px" >
                                ตรวจรับ <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                    @if ($store_rep !=0)
                                    <a href="{{ url('wh_recieve') }}" class="dropdown-item">ตรวจรับทั่วไป</a>
                                    @endif
                                </div>
                            </li>
                            {{-- <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                เบิก-จ่าย <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                    @if ($store_normal !=0)
                                    <a href="{{ url('wh_pay') }}" class="dropdown-item">เบิก-จ่ายทั่วไป</a>
                                    @endif
                                    @if ($store_vip !=0)
                                    <a href="{{ url('wh_main_pay') }}" class="dropdown-item">เบิก-จ่าย(พัสดุ)</a>
                                    @endif
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-layout">
                                    <div class="dropdown">
                                        ...
                                        <a class="dropdown-item dropdown-toggle arrow-none" href="{{url('wh_confix_store')}}" id="topnav-layout-verti" role="button">
                                            <span key="t-vertical">รายการคลัง</span>
                                        </a>
                                    </div>
                                </div>
                            </li>
