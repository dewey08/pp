                                        ...
                                        <div class="widget-content-left">
                                            <div class="btn-group">
                                                <a data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                                    ...
                                                    <img width="42" class="rounded-circle" src="{{ asset('assets/images/default-image.jpg') }}" alt="">
                                                    @else
                                                    <img width="42" class="rounded-circle" src="{{ asset('storage/person/' . Auth::user()->img) }}" alt="">
                                                    @endif
                                                                ...
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                                                        ...
                                                                        <div class="widget-content-right me-2">
                                                                            <a href="{{ route('logout') }}" class="btn-pill btn-shadow btn-shine btn btn-focus" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                                                    ...
                                                    <div class="scroll-area-xs" style="height: 70px;">
                                                        <div class="scrollbar-container ps">
                                                            <ul class="nav flex-column">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a href="javascript:void(0);" class="nav-link">Reset Password</a>
                                                                </li> --}}
