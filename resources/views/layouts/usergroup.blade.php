...
<head>
  ...
  <link href="{{ asset('css/tablegroup.css') }}" rel="stylesheet">
...
<body>
       <div id="app">
        <div class="px-3 py-2 bg-dark text-dark">
            <div class="container">
              <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                  ...
                  {{-- @if ($checkhn != 0)
                        <a href="{{ url('hn/hn_dashboard/'.Auth::user()->id) }}" class="btn btn-light text-dark me-2" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="custom-tooltip" title="หัวหน้า"  target="_blank"><i class="fa-solid fa-2x fa-user-tie text-warning"></i></a>
                        @endif
                        <a href="{{ url('rong/rong_bookindex/'.Auth::user()->id) }}" class="btn btn-light text-dark me-2" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="custom-tooltip" title="หัวหน้าบริหาร"  target="_blank"><i class="fa-solid fa-2x fa-user-tie text-secondary"></i></a>
                    @if ($checkhorg != 0)
                        <a href="{{ url('user/supplies_data') }}" class="btn btn-light text-white me-2" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="custom-tooltip" title="ผู้อำนวยการ"  target="_blank"><i class="fa-solid fa-2x fa-user-tie text-primary"></i></a>                   
                    @endif --}}
                    <li>
                  ...
                  <li>
                    <a href="{{ url('group/group_bookindex/'.Auth::user()->id) }}" class="nav-link text-white text-center"> 
                        <i class="fa-solid fa-2x fa-user-tie wext-white"></i>
                      <br>
                      หัวหน้ากลุ่ม
                    </a>
                  </li>
                  ...
                  <li>
                    <a href="{{url("po/po_bookindex/".Auth::user()->id)}}" class="nav-link text-white text-center"> 
                        <i class="fa-solid fa-2x fa-user-tie text-primary"></i>
                      <br>
                      ผู้อำนวยการ
                    </a>
                  </li>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      $('#book_saveForm').on('submit',function(e){
        ...
        $('#commentpo_saveForm').on('submit',function(e){
              e.preventDefault();  
              var form = this; 
              $.ajax({
                url:$(form).attr('action'),
