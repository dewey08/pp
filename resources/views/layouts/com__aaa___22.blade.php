...
<body data-topbar="light" data-layout="horizontal" style="background-color: rgb(240, 238, 238)">
    ...
    <div id="preloader">
        <div id="status">
            <div class="spinner">
                <i class="ri-loader-line spin-icon" style="font-size:200px"> </i>
                {{-- <i class="fa-solid fa-4x fa-spinner"></i> --}}
            </div>
        </div>
    </div>
    {{-- <div id="preloader" class="justify-content-center">
    ...
    <div id="layout-wrapper">
        ...
        {{-- <div class="topnav" style="color: rgb(4, 184, 124)"> --}}
            <div class="topnav" style="background-color:rgb(2, 131, 136) ">
                ...
                <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="{{url('warehouse/warehouse_index')}}" id="topnav-apps"
                                    role="button">
                                    <i class="ri-apps-2-line me-2"></i>ตรวจรับวัสดุ </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="{{url('warehouse/warehouse_pay')}}" id="topnav-apps"
                                    role="button">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="{{url('warehouse/warehouse_main')}}" id="topnav-apps"
                                    role="button">
