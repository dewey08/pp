                ...
                <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="{{ url('gas_stocklist') }}" id="topnav-more" role="button">
                                    <i class="fa-solid fa-fire-extinguisher me-2"></i>คลังเครื่องมือแพทย์
                                </a>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="{{ url('report_gas') }}" id="topnav-more" role="button">
                            ...
                            {{-- <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-layout" role="button">
                                    <i class="fa-solid fa-chart-line me-2"></i><span key="t-layouts">รายงานประจำเดือน</span> <div class="arrow-down"></div>

                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-layout">
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle arrow-none" href="{{url('report_gas_check_tank')}}" id="topnav-layout-verti"
                                            role="button">
                                            <span key="t-vertical">Tank Liquid Oxygen(Main)</span>
                                        </a>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle arrow-none" href="{{url('report_gas_check_tanksub')}}" id="topnav-layout-verti"
                                            role="button">
                                            <span key="t-vertical">Tank Liquid Oxygen(Sub)</span>
                                        </a>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle arrow-none" href="{{url('report_gas_check_nitrus')}}" id="topnav-layout-verti"
                                            role="button">
                                            <span key="t-vertical">ไนตรัสออกไซด์ (N2O-6Q)</span>
                                        </a>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle arrow-none" href="{{url('report_gas_check_o2')}}" id="topnav-layout-verti"
                                            role="button">
                                            <span key="t-vertical">ก๊าซอ๊อกซิเจน (2Q-6Q)</span>
                                        </a>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle arrow-none" href="{{url('report_gas_check_control')}}" id="topnav-layout-verti"
                                            role="button">
                                            <span key="t-vertical">Control Gas</span>
                                        </a>
                                    </div>
