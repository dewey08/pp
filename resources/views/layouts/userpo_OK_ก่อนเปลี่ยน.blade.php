...
<head>
  ...
  <link href="{{ asset('css/tablepo.css') }}" rel="stylesheet">
                ...
                <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                  ...
                  <li>
                    ...
                    <a class="dropdown-toggle text-white text-center mt-2" type="button" id="dropdownMenuButton" data-mdb-toggle="dropdown" aria-expanded="false" >
                      <i class="fa-solid fa-2x fa-user-tie text-info"></i>   <br>
                      ผู้ใช้งานทั่วไป
                    </a>
                  ...
                  {{-- <li>
                    <a href="{{ url('group/group_bookindex/'.Auth::user()->id) }}" class="nav-link text-white text-center"> 
                        <i class="fa-solid fa-2x fa-user-tie" style="color: rgb(99, 100, 100)"></i>
                      <br>
                      หัวหน้ากลุ่ม
                    </a>
                  </li> --}}
                  ...
                  <li>
                    <a href="{{url("po/po_bookindex/".Auth::user()->id)}}" class="nav-link text-white text-center"> 
                        <i class="fa-solid fa-2x fa-user-tie text-white"></i>
                      <br>
                      ผู้อำนวยการ
                    </a>
                  </li>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      $('#book_saveForm').on('submit',function(e){
        ...
        $('#signature_retiepoForm').on('submit',function(e){
              e.preventDefault();  
              var form = this; 
              $.ajax({
                url:$(form).attr('action'),
                ...
                success:function(data){
                  if (data.status == 0 ) {
                    ...
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {                  
                        window.location.reload(); 
                        // window.location = "{{url('po/po_bookindex')}}"; // กรณี add page new  
                      }
                    })      
                  }
                }
