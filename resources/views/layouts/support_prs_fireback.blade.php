                ...
                <div class="d-flex">
                    ...
                    <form class="app-search d-none d-lg-block mt-3 ms-3">
                        <div class="position-relative">
                            <h3 style="color:rgb(255, 255, 255)" class="mt-1 noto-sans-thai-looped-light">F I R E - E X T I N G U I S H E R</h3>
                        </div>
                    </form>
                </div>
                ...
                <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="{{ url('fire_stock') }}" id="topnav-more" role="button">
                                    <i class="fa-solid fa-store me-2"></i>คลังถังดับเพลิง
                                </a>
                            </li>
