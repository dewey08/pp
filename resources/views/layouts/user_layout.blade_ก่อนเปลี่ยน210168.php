 ...
 <body data-topbar="dark">
    ...
    <div id="layout-wrapper">
         ...
         <header id="page-topbar" class="input_border">
            <div class="navbar-header" style="background-color: rgb(238, 252, 255)" >
                ...
                <div class="d-flex">
                    ...
                    <form class="app-search d-none d-lg-block mt-3 ms-3">
                        <div class="position-relative">
                            @foreach ($org as $item)
                            <h2 style="color:rgb(3, 109, 158)" class="mt-2 noto-sans-thai-looped-light Head2">{{$item->orginfo_name}}</h2>
                            @endforeach
