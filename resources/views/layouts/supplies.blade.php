                        ...
                        <ul class="navbar-nav">
                            ...
                            {{-- <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="{{url('warehouse/warehouse_index')}}" id="topnav-apps"
                                    role="button">
                                    <i class="ri-apps-2-line me-2"></i>ขอซื้อขอจ้าง </a>
                            </li> --}}
                            {{-- <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-apps"
                                    role="button">
                                    <i class="ri-apps-2-line me-2"></i>จัดซื้อจัดจ้าง
                                </a>
                            </li> --}}
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="{{url('supplies/supplies_index')}}" id="topnav-apps"
                                    role="button">
                                    <i class="ri-apps-2-line me-2"></i>ข้อมูลวัสดุ
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="{{url('serve/serve_index')}}" id="topnav-apps"
                                    role="button">
                                    <i class="ri-apps-2-line me-2"></i>ข้อมูลบริการ
                                </a>
                            </li>
                            {{-- <li class="nav-item dropdown">
