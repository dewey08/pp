                ...
                <div class="d-flex">
                    ...
                    <form class="app-search d-none d-lg-block mt-3 ms-3">
                        <div class="position-relative">
                            <h3 style="color:rgb(255, 255, 255)" class="mt-1 noto-sans-thai-looped-light">C C T V - C A M E R A</h3> 
                        </div>
                    </form> 
                </div>
                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="{{ url('cctv_dashboard') }}" id="topnav-more" role="button">
                                    <i class="fa-solid fa-chart-pie me-2"></i>Dashboard  
                                </a> 
                            </li>

                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="{{ url('cctv_list') }}" id="topnav-more" role="button">
                                    <i class="fa-solid fa-fire-extinguisher me-2"></i>ทะเบียนกล้องวงจรปิด 
                                </a>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="{{ url('cctv_list_check') }}" id="topnav-more" role="button">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="{{ url('cctv_report') }}" id="topnav-more" role="button">
