...
<body>
    ...
    <div class="wrapper">
                            ...
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                                ...
                                <div class="user-setting d-flex align-items-center gap-1"> 
                                    ...
                                    <div class="user-name d-none d-sm-block">  
                                      {{ Auth::user()->fname }} {{ Auth::user()->lname }}</div>
                                </div>
                            </a>
        ...
        <aside class="sidebar-wrapper">
            <div class="iconmenu">
                <div class="nav-toggle-box bg-danger">
                    <div class="nav-toggle-icon"><i class="bi bi-list"></i></div>
                </div>
                <ul class="nav nav-pills flex-column"> 
                    <li class="nav-item" data-bs-toggle="tooltip" data-bs-placement="right" title="ตั้งค่าทั่วไป">
                        ...
                        <div class="list-group list-group-flush">
                            <div class="list-group-item">
                                <div class="d-flex w-100 justify-content-between">
                                    <h5 class="mb-0">ตั้งค่าทั่วไป</h5>
                                </div> 
                            </div>
                            <a href="{{ url('setting/setting_index')}}" class="list-group-item">   
                                <i class="fa-solid fa-building-user text-secondary"></i>  
                                กลุ่มงาน
                            </a>
                            <a href="{{ url('setting/depsub_index') }}" class="list-group-item"> 
