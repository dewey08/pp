            ...
            <header id="page-header">
                ...
                <div class="content-header"  >
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <i class="fa fa-1.5x fa-boxes text-warning"></i>
                            <span class="text-white-50"></span><span class="text-white" style="font-weight: normal;font-family: 'Kanit', sans-serif;">งานทรัพย์สิน</span>
                        </a>
                        <!-- END Logo -->
                        ...
                        <div id="main-navigation" class="d-none d-lg-block ">
                            ...
                            <ul class="nav-main nav-main-horizontal nav-main-hover ">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('manager_asset/dashboard') ? ' active' : '' }}" href="{{ url('manager_asset/dashboard') }}">
                                ...
                                <li class="nav-main-item"> 
                                    <a class="nav-main-link{{ request()->is('manager_asset/assetinfoland') ? ' active' : '' }}" href="{{ url('manager_asset/assetinfoland') }}">
                                            <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                            <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ที่ดิน</span>                        
                                    </a>
                                </li>
                                <li class="nav-main-item"> 
                                    <a class="nav-main-link{{ request()->is('manager_asset/assetinfobuilding') ? ' active' : '' }}" href="{{ url('manager_asset/assetinfobuilding') }}">
                                            <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                            <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">อาคาร/สิ่งปลูกสร้าง</span>                        
                                    </a>
                                </li>
                                <li class="nav-main-item"> 
                                        <a class="nav-main-link{{ request()->is('manager_asset/assetinfo') ? ' active' : '' }}" href="{{ url('manager_asset/assetinfo') }}">
                                                <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                                <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">ทะเบียนครุภัณฑ์</span>                        
                                        </a>
                                </li>
                                <li class="nav-main-item"> 
                                    <a class="nav-main-link{{ request()->is('manager_asset/suppliesinfoarticle') ? ' active' : '' }}" href="{{ url('manager_asset/suppliesinfoarticle') }}">
                                            <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                ...
                                <li class="nav-main-item"> 
                                    <a class="nav-main-link{{ request()->is('manager_asset/assetinfocalculate') ? ' active' : '' }}" href="{{ url('manager_asset/assetinfocalculate') }}">
                                            <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                            <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">คำนวณค่าเสื่อม</span>                        
                                    </a>
                                </li>
                                <li class="nav-main-item"> 
                                    <a class="nav-main-link{{ request()->is('manager_asset/assetinfodisburse') ? ' active' : '' }}" href="{{ url('manager_asset/assetinfodisburse') }}">
                                            <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                            <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">การเบิก-จ่าย</span>                        
                                    </a>
                                </li>
                                <li class="nav-main-item"> 
                                    <a class="nav-main-link{{ request()->is('manager_asset/assetinfolend') ? ' active' : '' }}" href="{{ url('manager_asset/assetinfolend') }}">
                                            <i class="nav-main-link-icon fa fa-calendar-alt"></i>
                                            <span class="nav-main-link-name" style="font-size: 14px;font-family: 'Kanit', sans-serif;">การยืม-คืน</span>                        
                                    </a>
                                </li>
