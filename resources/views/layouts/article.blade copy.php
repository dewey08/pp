                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="{{url('land/land_index')}}" id="topnav-apps"
                                    role="button">
                                    <i class="ri-apps-2-line me-2"></i>ข้อมูลที่ดิน </a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="{{url('building/building_index')}}" id="topnav-apps"
                                    role="button">
                                    <i class="ri-apps-2-line me-2"></i>ข้อมูลอาคาร
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="{{url('article/article_index')}}" id="topnav-apps"
                                    role="button">
                                    <i class="ri-apps-2-line me-2"></i>ข้อมูลครุภัณฑ์
                                </a>
                            </li>
                            {{-- <li class="nav-item dropdown">
