       ...
       <div id="app">
        <div class="px-3 py-2 bg-head text-white">
            <div class="container">
              ...
              <label for="" style="color: rgb(250, 180, 134);font-size:45px">OF</label>
                ...
                <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                  ...
                  <li>
                    <a href="{{url("staff/home")}}" class="nav-link text-white position-relative text-center">
                      ...
                      <span class="position-absolute top-0 start-70 translate-middle badge rounded-pill bg-success">2 <span class="visually-hidden">unread messages</span></span>
                      <br>
                      ข้อความ
                    </a>
                  </li>
