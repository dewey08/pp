...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
   ...
   <link href="{{ asset('css/sizebarrong.css') }}" rel="stylesheet">
   <link href="{{ asset('css/tablerong.css') }}" rel="stylesheet">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-body">
                ...
                <ul class="navigation-list">
                    ...
                    --}}
                    <li class="navigation-list-item {{'rong/rong_bookindex/'.Auth::user()->id == request()->path() ? 'active':''}} || {{'rong/rong_bookindex_detail/'.Auth::user()->id == request()->path() ? 'active':''}} ">
                        <a class="navigation-link" href="{{url('rong/rong_bookindex/'.Auth::user()->id)}}">
                            <div class="row">
                                <div class="col-2">
                                ...
                                <div class="col-1">
                                    <span class="badge bg-success ms-2">{{$count_bookrep_rong}}</span>
                                </div>
                            </div>
                        </a>
                    </li>
                    <li class="navigation-list-item {{'rong/rong_leaveindex/'.Auth::user()->id == request()->path() ? 'active':''}}">
                        <a class="navigation-link" href="{{url('rong/rong_leaveindex/'.Auth::user()->id)}}">
                            <div class="row">
                                <div class="col-2">
                    ...
                    <li class="navigation-list-item {{'rong/rong_trainindex/'.Auth::user()->id == request()->path() ? 'active':''}}">
                        <a class="navigation-link" href="{{url('rong/rong_trainindex/'.Auth::user()->id)}}">
                            <div class="row">
                                <div class="col-2">
                    ...
                    <li class="navigation-list-item {{'rong/rong_purchaseindex/'.Auth::user()->id == request()->path() ? 'active':''}}">
                        <a class="navigation-link" href="{{url('rong/rong_purchaseindex/'.Auth::user()->id)}}">
                            <div class="row">
                                <div class="col-2">
                                ...
                                <div class="col-1">
                                    <span class="badge bg-success ms-2">{{$count_suprephn}}</span>
                                </div>
                            </div>
                        </a>
                    </li>
                    <li class="navigation-list-item {{'rong/rong_storeindex/'.Auth::user()->id == request()->path() ? 'active':''}}">
                        <a class="navigation-link" href="{{url('rong/rong_storeindex/'.Auth::user()->id)}}">
                            <div class="row">
                                <div class="col-2">
                                    <i class="fas fa-calendar-alt"></i>
                                </div>
