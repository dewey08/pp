 ...
 ?>
    <div class="px-3 py-2 border-bottom">
        <div class="container d-flex flex-wrap justify-content-center">
            ...
            <a href="{{ url('housing/housing_dashboard') }}" class="btn btn-outline-info btn-sm text-dark shadow me-2">dashboard  </a>
            <a href="{{ url('housing/housing_index') }}" class="btn btn-info btn-sm text-white shadow me-2">รายการบ้านพัก <span class="badge bg-danger ms-2">{{$count_hosing}}</span></a>
            <a href="{{ url('housing/housing_request') }}" class="btn btn-outline-info btn-sm text-dark shadow me-2">รายการขอเข้าพัก <span class="badge bg-danger ms-2">{{$count_hosing}}</span></a>
            <a href="{{ url('housing/housing_appeal') }}" class="btn btn-outline-info btn-sm text-dark shadow me-2">ร้องเรียนปัญหา <span class="badge bg-danger ms-2">{{$count_hosing}}</span></a>
            <a href="{{ url('housing/housing_report') }}" class="col-4 col-lg-auto mb-2 mb-lg-0 me-lg-auto btn btn-outline-info btn-sm text-dark shadow me-2">รายงาน</a>
