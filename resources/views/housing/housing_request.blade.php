 ...
 ?>
    <div class="px-3 py-2 border-bottom">
        <div class="container d-flex flex-wrap justify-content-center">
            ...
            <a href="{{ url('housing/housing_request') }}" class="btn btn-info btn-sm text-white me-2">รายการขอเข้าพัก <span class="badge bg-danger ms-2">{{$count_hosing}}</span></a>
            <a href="{{ url('housing/housing_appeal') }}" class="btn btn-light btn-sm text-dark me-2">ร้องเรียนปัญหา <span class="badge bg-danger ms-2">{{$count_hosing}}</span></a>
