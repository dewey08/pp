                                ...
                                <div class="col-md-3 mt-2">
                                    <div class="form-outline bga">
                                        <input type="text" id="CAR_LOCATION_INSERT" name="CAR_LOCATION_INSERT"
                                            class="form-control form-control-sm shadow" placeholder="เพิ่มสถานที่ไป" />
                                ...
                                <div class="col-md-10 mt-2">
                                    <div class="form-outline">
                                        <input id="car_service_reason" type="text"
                                            class="form-control form-control-sm input-rounded" name="car_service_reason">
                    ...
                    select: function(start, end, allDays) {
                        ...
                        .val(); // aray mutiselect2
                            ...
                            var carservice_length_godate = $(
                                '#car_service_length_godate').val();
                            var carservice_length_backdate = $(
                                '#car_service_length_backdate').val();
