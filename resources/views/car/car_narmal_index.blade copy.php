...
@section('menu')
    <style>
        ...
        .btn2 {
            ...
            color: black;
            border: 2px solid #ffffff00; /* Green */
        }
    </style>
     <?php
                                                    ...
                                                    <div class="dropdown">
                                                      ...
                                                      <ul class="dropdown-menu">
                                                            ...
                                                            <li class="dropdown-item menu">
                                                                <button type="button" class="btn2 edit_line" style="background: white;border-color: :white" value="{{ $item->car_service_id }}" 
                                                                    data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-custom-class="custom-tooltip"
                                                                    title="แก้ไข" >
                                                                    <i class="fa-solid fa-pen-to-square me-2 text-warning"></i>
                                                                    <label for="" style="color: rgb(248, 158, 23)">จัดการ</label> 
                                                                </button>
                                                            </li>
                                                            <li>
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                  <div class="modal-content">                                                        
                                                    ...
                                                    <div class="row ">                                                                                                                 
                                                        ...
                                                        <div class="col-md-3 mt-2">
                                                            <div class="form-group">  
                                                                {{-- <input type="text" id="DRIVE_INSERT" name="DRIVE_INSERT" class="form-control"/>                                                                                                               --}}
