            ...
            <div class="card shadow-lg">
              ...
              <div class="card-header">
                ...
                <div class="card-body"> 
                    <div class="row">
                          <div class="col-md-9">
                            <form class="custom-validation" action="{{ route('meetting.meetting_save') }}" method="POST" enctype="multipart/form-data">
                            {{-- id="insert_meetingForm" enctype="multipart/form-data"> --}}
                            @csrf
                            <input type="hidden" id="ROOM_ID" name="room_id" value="{{$building_level_room->room_id}}" > 

                            <input type="hidden" id="iduser" name="iduser" value="{{Auth::user()->id}}">
                              <div class="row">  
                                {{-- <div style="color: red;" class="checkroom"> 
                                    <label for="">udududuud</label>
                                 </div> --}}
                                ...
                                <div class="row mt-3">  
                                  ...
                                  <div class="col-md-3">
                                      <div class="form-group">
                                          <input id="MEETTING_DATE_BEGIN" type="date" class="form-control @error('meeting_date_begin') is-invalid @enderror" name="meeting_date_begin" value="{{ old('meeting_date_begin') }}" autocomplete="meeting_date_begin" onchange="checkroom();checkdate();">
                                  ...
                                  <div class="col-md-3">
                                      <div class="form-group">
                                          <input id="meeting_date_end" type="date" class="form-control @error('meeting_date_end') is-invalid @enderror" name="meeting_date_end" value="{{ old('meeting_date_end') }}" autocomplete="meeting_date_end" onchange="checkdate();">
                                ...
                                <div class="row mt-3">  
                                  ...
                                  <div class="col-md-3">
                                      <div class="form-group">
                                          <input id="MEETTING_TIME_BEGIN" type="time" class="form-control @error('meeting_time_begin') is-invalid @enderror" name="meeting_time_begin" value="{{ old('meeting_time_begin') }}" autocomplete="meeting_time_begin" >
                                    ...
                                    <table class="table-bordered table-striped table-vcenter" style="width: 100%;">
                                        ...
                                        <tbody class="tbody1"> 
                                                <tr height="40">
                                                    ...
                                                    <td>
                                                        <input name="MEETTINGLIST_QTY[]" id="meeting_list_qty0" class="form-control">
                                                    </td>                                               
...
{{-- @include('/user_meetting/meetting_choose_modal') --}}
...
<script>
    ...
    $('.addRow1').on('click',function(){
        ...
        var tr ='<tr>'+
                ...
                '</td>'+               
                '<td>'+
                '<input name="MEETTINGLIST_QTY[]" id="meeting_list_qty'+count+'" class="form-control">'+
                '</td>'+ 
