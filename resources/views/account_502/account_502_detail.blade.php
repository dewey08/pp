        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0" style="color:rgb(248, 28, 83)">รายละเอียดข้อมูล 1102050101.502</h4>
            ...
            <div class="col-md-12">
                <div class="card card_audit_4c" style="background-color: rgb(246, 235, 247)">
                    <div class="card-body">
                            ...
                            {{-- <table id="datatable-buttons" class="table table-smtable-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;"> --}}
                            ...
                            <tr style="background-color: #f3fca1">
                                ...
                                <td class="text-center" style="background-color: #0652aa"><label for="" style="color: #0652aa">{{ number_format($total1, 2) }}</label></td>
                                <td class="text-center" style="background-color: #06858a" ><label for="" style="color: #06858a">{{ number_format($total2, 2) }}</label></td>
                                <td class="text-center" style="background-color: #0c7dc9"><label for="" style="color: #0c7dc9">{{ number_format($total3, 2) }}</label> </td>
                            </tr>
                        </table>
                    </div>
                </div>
