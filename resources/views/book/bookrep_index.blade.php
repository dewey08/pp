...
<style>
  .btn{
    ...
    <div class="px-3 py-2 border-bottom">
        ...
        <a href="{{url("book/bookmake_index")}}" class="btn btn-secondary btn-rounded btn-sm text-white shadow me-2">งานที่ต้องทำ</a>  
        {{-- <a href="{{url("book/bookrep_index")}}" class="btn btn-primary btn-rounded text-white shadow me-2">สร้างงานใหม่</a> --}}
        {{-- <a href="{{url("book/bookrep_index_add")}}" class="btn btn-primary btn-rounded text-white shadow me-2">สร้างงานใหม่</a>     --}}
        <a href="{{url("book/bookrep_index_add")}}" class="btn btn-secondary btn-rounded btn-sm text-white shadow me-2">สร้างงานใหม่</a>  
        <a href="{{url("book/booksend_index")}}" class="col-4 col-lg-auto mb-2 mb-lg-0 me-lg-auto btn btn-secondary btn-rounded btn-sm shadow text-white me-2">หนังสือส่ง</a>  
        <div class="text-end"> 
            {{-- <a href="{{url("book/bookrep_index_add")}}" class="btn btn-success btn-rounded">ออกเลขหนังสือรับ</a> --}}
