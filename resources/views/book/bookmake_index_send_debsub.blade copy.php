                    ...
                    <!-- Pills navs -->
                        <ul class="nav nav-pills" id="ex1" role="tablist">
                            ...
                            <li class="nav-item" role="presentation"> 
                                <a class="nav-link " href="{{url('book/bookmake_index_send/'.$dataedits->bookrep_id)}}" ><label class="xl">รายละเอียด</label> </a>
                            </li>
                            <li class="nav-item" role="presentation"> 
                                <a class="nav-link" href="{{url('book/bookmake_index_send_deb/'.$dataedits->bookrep_id)}}" >&nbsp;&nbsp;<label class="xl">ส่งกลุ่มงาน</label>&nbsp;&nbsp; </a>
                            </li>
                            <li class="nav-item" role="presentation"> 
                                <a class="nav-link active" href="{{url('book/bookmake_index_send_debsub/'.$dataedits->bookrep_id)}}" >&nbsp;<label class="xl">ส่งฝ่าย/แผนก</label>&nbsp;</a>
                            </li>
                            <li class="nav-item" role="presentation"> 
            ...
            <div class="col-md-12 "> 
                <div class="card-body shadow-lg "> 
                    ...
                    <div class="tab-pane fade show active" id="ex1-pills-3" role="tabpanel" aria-labelledby="ex1-tab-3">
                            <form action="{{route('book.bookmake_index_senddepsub')}}" id="Save_senddepsub" method="POST">
                                @csrf                             
