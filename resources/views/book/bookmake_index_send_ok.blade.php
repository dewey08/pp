  ...
  function bookmake_sendretire(bookrep_id)
          {
            // alert(bookrep_id);
            Swal.fire({
            title: 'ต้องการเสนอหัวหน้าบริหารใช่หรือไหม?',
      ...
      <div class="container d-flex flex-wrap justify-content-center"> 
          ...
          <div class="text-end"> 
            @if ($bookcount == 0)
                ...
                <button type="button" class="btn btn-success btn-sm mt-2" data-bs-toggle="modal" data-bs-target="#saexampleModal">
                    ความคิดเห็น
                    </button>
            @endif
              
              {{-- <a href="" class="btn btn-success btn-sm text-white shadow me-2">เสนอผู้อำนวยการ</a> --}}
          </div>
      </div>
  </div>
  @endsection
                        ...
                        <ul class="nav nav-pills" id="ex1" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="ex1-tab-6" data-mdb-toggle="pill" href="#ex1-pills-6"
                                    role="tab" aria-controls="ex1-pills-6" aria-selected="false" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label class="xl">ฟล์แนบ</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </a >
                            </li>
                            <li class="nav-item" role="presentation">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row mt-3">
                <div class="col-md-2">
                    <label for="pcustomer_code">ความเห็นที่ </label>
                </div>
                <div class="col-md-10">
                    <div class="form-group">
        ...
        <div class="modal-footer"> 
          <button type="submit" class="btn btn-secondary">บันทึกความคิดเห็น</button>
          <a href="javascript:void(0)" onclick="bookmake_sendretire({{$dataedits->bookrep_id}})" class="btn btn-primary text-white shadow me-2">เสนอหัวหน้าบริหาร</a>
