                                  ...
                                  <div class="row justify-content-center">
                                        <div class="col-md-3">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input id="DEPARTMENT_NAME" type="text" class="form-control form-control-sm" name="DEPARTMENT_NAME"  value="{{$dataedits->DEPARTMENT_NAME }}">
                                          </div>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                          <label for="">Line Token</label>
                                            <div class="form-group">
                                                ...
                                                <input id="LINE_TOKEN" type="text" class="form-control form-control-sm" name="LINE_TOKEN" value="{{$dataedits->LINE_TOKEN }}">
                                            </div>
                                        </div>
