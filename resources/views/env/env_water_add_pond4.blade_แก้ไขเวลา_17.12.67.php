...
<div class="container-fluid" style="width: 100%">
    <div class="row ">
        <div class="col-md-4">
            <h3 style="color:green ">น้ำประปา</h3>
            <p class="card-title-desc">ข้อมูลตรวจวัดค่าพารามิเตอร์</p>
        </div>
    </div>


    <form action="{{ route('env_water_add_pond4_save')}}" method="POST" >
        @csrf
        ...
        <input id="pond_id" type="hidden" class="form-control form-control-sm" name="pond_id" value="{{$idpond}}">
            ...
            <div class="row">
                ...
                <div class="col-md-2" >
                    <div class="form-group">
                        <input id="water_time" type="time" class="form-control form-control-sm" name="water_time" value="{{$data_mm}}">
                    </div>
                </div>
