        ...
        <div class="tabs-animation">
            ...
            <div class="row">
                ...
                <div class="col-md-2 text-end">
                    <a href="{{url('upstm_all')}}" class="ladda-button btn-pill btn btn-sm btn-primary d-shadow me-2 ms-4 cardacc" data-style="expand-left">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-ucs" role="tabpanel" aria-labelledby="v-pills-ucs-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card card_audit_4c">
                                        <div class="card-body ">
                                            <h4 class="card-title" style="color:rgb(247, 31, 95)">STM DETAIL UCS IPD 202:::: >> {{$STMDoc}}</h4>
                                            <div class="table-responsive">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($datashow as $item)
                                                            ...
                                                            <tr height="20">
                                                                ...
                                                                <td class="text-center" style="color:rgb(10, 151, 85);font-size:13px" width="10%">{{ number_format($item->stm_money, 2) }}</td>
                                                                <td class="text-center" style="color:rgb(17, 112, 68);font-size:13px" width="10%">{{ number_format($item->total_approve, 2) }}</td>
                                                            </tr>
                                                            <?php
