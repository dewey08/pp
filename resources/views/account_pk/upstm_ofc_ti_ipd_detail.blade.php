        ...
        <div class="tabs-animation">
            ...
            <div class="row"> 
                ...
                <div class="col-md-2 text-end">
                    <a href="{{url('upstm_ofc_ti_ipd')}}" class="ladda-button btn-pill btn btn-primary d-shadow me-2 ms-4 cardacc" data-style="expand-left">
                    ...
                    <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="v-pills-ucs" role="tabpanel" aria-labelledby="v-pills-ucs-tab">
                            <div class="row"> 
                                <div class="col-md-12">
                                    <div class="card p-4 card_pink">
                                        <h4 class="card-title" style="color:rgb(10, 151, 85)">STM DETAIL OFC TI 4022 :::: >> {{$STMDoc}}</h4>
                                        <div class="table-responsive">
                                            {{-- <table id="example2" class="table table-striped table-bordered " style="border-collapse: collapse; border-spacing: 0; width: 100%;"> --}}
                                                ...
                                                <tr style="background-color: #f3fca1">
                                                    ...
                                                    <td class="text-center" style="background-color: rgb(233, 83, 14)"><label for="" style="color: #136fd8;font-size:15px">{{ number_format($total1, 2) }}</label></td>
                                                    <td class="text-center" style="background-color: rgb(18, 118, 233)"><label for="" style="color: #136fd8;font-size:15px">{{ number_format($total2, 2) }}</label></td>
                                                    <td class="text-center" style="background-color: rgb(10, 151, 85)"><label for="" style="color: #136fd8;font-size:15px">{{ number_format($total3, 2) }}</label> </td>  
                                                </tr>  
                                            </table>
                                        </div>
                                    </div>
