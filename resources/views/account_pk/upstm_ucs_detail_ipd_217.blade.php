        ...
        <div class="tabs-animation">
            ...
            <div class="row">
                ...
                <div class="col-md-2 text-end">
                    <a href="{{url('upstm_ucs_ipd217')}}" class="ladda-button btn-pill btn btn-sm btn-primary d-shadow me-2 ms-4 cardacc" data-style="expand-left">
                                            ...
                                            @foreach ($ucs_217 as $item_1)
                                                ...
                                                <tr height="20">
                                                    <td class="text-start" style="color:rgb(34, 90, 243);font-size:14px">
                                                        ...
                                                        <td class="text-end" style="color:rgb(10, 151, 85);font-size:14px" width="30%">{{ number_format($item_1->total, 2) }}</td>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                        ...
                        <div class="tab-pane fade show active" id="v-pills-ucs" role="tabpanel" aria-labelledby="v-pills-ucs-tab">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card_audit_4c">
                                        <div class="card-body ">
                                            <h4 class="card-title" style="color:rgb(247, 31, 95)">STM DETAIL UCS IPD 217:::: >> {{$STMDoc}}</h4>
                                            <div class="table-responsive">
                                                {{-- <table id="example" class="table table-sm table-striped table-bordered" style="width: 100%;"> --}}
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($datashow as $item)
                                                            ...
                                                            <tr height="20">
                                                                ...
                                                                <td class="text-start" style="color:rgb(34, 90, 243);font-size:14px"> {{ $item->ptname }}</td>
                                                                ...
                                                                <td class="text-center" style="color:rgb(35, 204, 125);font-size:13px" width="10%">{{ number_format($item->total_217, 2) }}</td>
                                                                <td class="text-center" style="color:rgb(10, 151, 85);font-size:13px" width="10%">{{ number_format($item->total_approve, 2) }}</td>
                                                                <td class="text-center" style="color:rgb(10, 151, 85);font-size:13px" width="10%">{{ number_format($item->auton, 2) }}</td>
                                                            </tr>
                                                            <?php
                                                                    ...
                                                                    $total5 = $total5 + $item->auton;
                                                            ?>
                                                        @endforeach
                                                    </tbody>
                                                    <tr style="background-color: #f3fca1">
                                                        <td colspan="6" class="text-end" style="background-color: #ffdede"></td>
                                                        <td class="text-center" style="background-color: rgb(233, 83, 14)"><label for="" style="color: #046fb6;font-size:1px;">{{ number_format($total1,2) }}</label></td>
                                                        ...
                                                        <td class="text-center" style="background-color: rgb(35, 204, 125)"><label for="" style="color: #046fb6;font-size:15px">{{ number_format($total5,2) }}</label> </td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
