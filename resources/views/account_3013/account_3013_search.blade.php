                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item)
                                    ...
                                    <tr height="20" style="font-size: 14px;">
                                        ...
                                        {{-- <td class="text-center" style="color:rgb(155, 50, 18)" width="6%">{{ number_format($item->debit_drug,2)}}</td> --}}
                                        {{-- <td class="text-center" style="color:rgb(155, 50, 18)" width="6%">{{ number_format($item->debit_instument,2)}}</td> --}}
                                        {{-- <td class="text-center" style="color:rgb(155, 50, 18)" width="6%">{{ number_format($item->debit_toa,2)}}</td> --}}
                                        {{-- <td class="text-center" style="color:rgb(155, 50, 18)" width="6%">{{ number_format($item->debit_refer,2)}}</td> --}}
                                        {{-- <td class="text-center" style="color:rgb(73, 147, 231)" width="6%">{{ number_format($item->income,2)}}</td> --}}
                                        <td class="text-center" style="color:rgb(113, 17, 151)" width="6%">{{ number_format($item->debit_total,2)}}</td>
                                        <td class="text-center" style="color:rgb(216, 95, 14)" width="6%">{{ number_format($item->toklong,2)}}</td>
                                ...
                                @endforeach
                                    ...
                                    <tr style="background-color: #f3fca1">
                                        ...
                                        <td class="text-center" style="background-color: #a20dcf;color:rgb(106, 15, 158)">{{ number_format($total7,2)}}</td>
                                        <td class="text-center" style="background-color: #bbf0e3">{{ number_format($total8,2)}}</td>
                                        <td colspan="5" class="text-center" style="background-color: #ff9d9d"></td>
                                    </tr>
                        </table>
                    </div>
                    </div>
