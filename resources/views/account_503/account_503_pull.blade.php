...
@section('content')
    ...
    <div class="tabs-animation">
        ...
        <form action="{{ URL('account_503_pull') }}" method="GET">
            @csrf
        <div class="row">
            <div class="col-md-4">
                <h5 class="card-title" style="color:rgb(248, 28, 83)">Detail 1102050101.503</h5>
                <p class="card-title-desc">รายละเอียดข้อมูลผัง 1102050101.503</p>
            </div>
            <div class="col"></div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3 text-end">
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-info btn-sm input_new Check_sit" data-url="{{url('account_503_checksit')}}">
                                    <img src="{{ asset('images/Check_sitwhite.png') }}" class="me-2 ms-2" height="18px" width="18px">
                                    ตรวจสอบสิทธิ์
                                </button>
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-primary btn-sm input_new Savestamp" data-url="{{url('account_503_stam')}}">
                                    <img src="{{ asset('images/Stam_white.png') }}" class="me-2 ms-2" height="18px" width="18px">
                                    ตั้งลูกหนี้
                                </button>
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-danger btn-sm input_new Destroystamp" data-url="{{url('account_503_destroy')}}">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($acc_debtor as $item)
                                            <tr id="tr_{{$item->acc_debtor_id}}">
                                                ...
                                                <td class="text-center" width="7%">{{ number_format($item->rcpt_money, 2) }}</td>
                                                <td class="text-center" width="7%">{{ number_format($item->debit_total, 2) }}</td>
                                                <td class="text-center" width="7%">{{ number_format($item->toklong, 2) }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
