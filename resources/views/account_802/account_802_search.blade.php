...
?>
    ...
    <div class="tabs-animation">
        ...
        <form action="{{ URL('account_802_search') }}" method="GET">
            @csrf
        <div class="row">
            <div class="col-md-4">
                <h5 class="card-title" style="color:rgb(247, 31, 95)">Search Detail 1102050102.802</h5>
                <p class="card-title-desc">ค้นหาลูกหนี้ ผัง 1102050102.802</p>
            </div>
            <div class="col"></div>
            ...
            <div class="col-md-5 text-end">
                <div class="input-daterange input-group" id="datepicker1" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker" data-date-container='#datepicker1'>
                    ...
                    <button type="button" class="ladda-button me-2 btn-pill btn btn-primary btn-sm input_new Savestamp" data-url="{{url('account_802_send')}}">
                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item)
                                    ...
                                    <tr height="20" style="font-size: 14px;">
                                        ...
                                        <td class="text-center" width="5%"><input type="checkbox" class="dcheckbox_ sub_chk" data-id="{{$item->acc_1102050102_802_id}}"> </td>
                                ...
                                @endforeach
                                        ...
                                        <tr style="background-color: #f3fca1">
                                            ...
                                            <td class="text-center" style="background-color: #e09be9;color:#0971b6">{{ number_format($total6,2)}}</td>
                                            <td class="text-center" style="background-color: #f5a382;color:#0971b6">{{ number_format($total7,2)}}</td>
                                            <td class="text-center" style="background-color: #bbf0e3;color:#0971b6">{{ number_format($total8,2)}}</td>
                                            {{-- <td class="text-end" style="background-color: #bbf0e3">{{ number_format($total9,2)}}</td>   --}}
                                            <td class="text-center" style="background-color: #ff9d9d;color:#0971b6"></td>
                                        </tr>
                        </table>
                    </div>
                    </div>
