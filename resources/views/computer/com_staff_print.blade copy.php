...
<div class="container">
    ...
    <div class="col-md-12" style="margin-top:3px;">
        ...
        <span style="margin-left:50px;"><b> ดดด</b></span>
    ...
    <div class="col-md-12 font-content">
        ...
        {{-- <span><b>{{$dataedits->com_repaire_no}}</b></span> --}}
        <span style="margin-left: 30px;">วันที่ :</span>
        <span><b>{{DateThai($dataedits->com_repaire_date)}}</b></span>
        <span style="margin-left: 30px;">เวลา :</span>
        <span><b>{{date("H:i น.",strtotime($dataedits->com_repaire_time))}}</b></span>
    </div>
    <div class="col-md-12 font-content">
        <span>แจ้งซ่อม : </span>
        <span style="margin-left: 50px;"><b> </b></span>
        <span style="margin-left: 50px;">ยี่ห้อ/รุ่น : </span>
        <span>.......................</span>
    </div>
    <div class="col-md-12 font-content">
        <span>หมายเลขครุภัณฑ์ : </span>
        <span style="margin-left:50px;">{{$dataedits->com_repaire_article_num}}</span>
    </div>
    <div class="col-md-12 font-content">
        <span>อาการ :</span>
        <span><b>{{$dataedits->com_repaire_detail}}</b></span>
    </div>
    <br><br>
    <div class="col-md-12 font-content">
    ...
    <div class="col-md-12">
        ...
        <span>{{$dataedits->com_repaire_detail_tech}}</span><br>
