...
@section('content')
    ...
    <div class="tabs-animation">
        ...
        <form action="{{ route('acc.acc_mareng_pull') }}" method="GET">
            @csrf
        <div class="row">
            <div class="col-md-4">
                <h5 class="card-title" style="color:rgb(247, 31, 95)">Process data 1102050101.201 ( มะเร็ง )</h5>
                <p class="card-title-desc">ประมวลผลข้อมูล ตั้งลูกหนี้/เคลม ผัง 1102050101.201</p>
            </div>
            <div class="col"></div>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6 text-start">
                              ...
                              @else
                                ...
                                <button class="ladda-button me-2 btn-pill btn btn-danger btn-sm input_new" onclick="uncheck()">Uncheck</button>
                              @endif
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-sm btn-warning input_new Claim" data-url="{{url('acc_mareng_claim')}}">
                                    <img src="{{ asset('images/loading_white.png') }}" class="me-2 ms-2" height="18px" width="18px">
                                   ประมวลผล
                               </button>
                               <a href="{{url('acc_mareng_claim_zip')}}" class="ladda-button me-2 btn-pill btn btn-sm btn-success input_new">
                            ...
                            <div class="col-md-4 text-end">
                                ...
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-info btn-sm input_new Check_sit" data-url="{{url('acc_mareng_checksit')}}">
                                    <img src="{{ asset('images/Check_sitwhite.png') }}" class="me-2 ms-2" height="18px" width="18px">
                                    ตรวจสอบสิทธิ์
                                </button>

                                <button type="button" class="ladda-button me-2 btn-pill btn btn-primary btn-sm input_new Savestamp" data-url="{{url('acc_mareng_stam')}}">
                                    <img src="{{ asset('images/Stam_white.png') }}" class="me-2 ms-2" height="18px" width="18px">
                                    ตั้งลูกหนี้
                                </button>
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-danger btn-sm input_new Destroystamp" data-url="{{url('acc_mareng_destroy_all')}}">
                ...
                Swal.fire({ position: "top-end",
                        ...
                        confirmButtonText: 'Yes, pull it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('acc.acc_mareng_pulldata') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {
                                        datepicker,
