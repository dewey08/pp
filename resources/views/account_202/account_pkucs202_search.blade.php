            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="card-title" style="color:rgb(247, 31, 95)">Detail 1102050101.202</h4>
                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item)
                                    ...
                                    <tr height="20" style="font-size: 14px;">
                                        ...
                                        <td class="text-center" style="color:rgb(155, 50, 18)" width="6%">{{ number_format($item->debit_instument,2)}}</td>
                                        ...
                                        <td class="text-center" style="color:rgb(155, 50, 18)" width="6%">{{ number_format($item->debit_ucep,2)}}</td>
                                        ...
                                        <td class="text-center" style="color:rgb(9, 196, 180)" width="6%">{{ number_format($item->stm_total,2)}}</td>
                                        <td class="text-start" width="9%">{{ $item->STMdoc }}</td>
                                        <td class="text-center" style="color:rgb(9, 196, 180)" width="6%">{{ $item->auton}}</td>
                                ...
                                @endforeach
                                        ...
                                        <tr style="background-color: #f3fca1">
                                            <td colspan="6" class="text-center" style="background-color: #ff9d9d"></td>
                                            ...
                                            <td class="text-center" style="background-color: #ace5fc">{{ number_format($total5,2)}}</td>
                                            <td class="text-center" style="background-color: #ff9d9d;color:#05a4af"></td>
                                            {{-- <td class="text-end" style="background-color: #ace5fc">{{ number_format($total10,2)}}</td>  --}}

                                            <td class="text-center" style="background-color: #e09be9;color:#05a4af">{{ number_format($total6,2)}}</td>
                                            <td class="text-center" style="background-color: #f5a382;color:#05a4af">{{ number_format($total7,2)}}</td>
                                            <td class="text-center" style="background-color: #bbf0e3;color:#05a4af">{{ number_format($total8,2)}}</td>
                                            <td class="text-center" style="background-color: #bbf0e3;color:#05a4af">{{ number_format($total9,2)}}</td>
                                            <td class="text-center" style="background-color: #ff9d9d;color:#05a4af"></td>
                                            <td class="text-center" style="background-color: #bbf0e3;color:#05a4af">{{ $total10}}</td>
                                            <td class="text-center" style="background-color: #ff9d9d;color:#05a4af"></td>
                                        </tr>
                        </table>
                    </div>
