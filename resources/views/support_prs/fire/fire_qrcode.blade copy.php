    ...
    <div class="row mt-5">
        <div class="col-md-3 text-center">
            <table class="text-center"> 
                <tr>
                    <td>   
                        {{-- {!! QrCode::size(112)->encoding('UTF-8')->generate(asset($dataprint->fire_num));!!}  --}}
                        {!! QrCode::size(112)->encoding('UTF-8')->generate($dataprint->fire_num);!!} 
                    </td> 
                </tr>
                <tr > 
                    <td>  
                       <p style="font-size: 17px"> รหัส {{ $dataprint->fire_num }}</p>
                        <p style="font-size: 17px">แสกนดูผลตรวจสอบ</p> 
                    </td> 
                </tr>
            </table> 
        </div>
