...
<div class="tabs-animation">
        ...
        <div id="preloader">
            <div id="status">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card bt_prs">

                            <div class="card-header">

                                <form action="{{ URL('fire_stock') }}" method="GET">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-4">
                                            <h4 style="color:rgb(246, 248, 248)">รายละเอียดการตรวจรับถังดับเพลิง</h4>
                                        </div>
                                        ...
                                        <div class="col-md-4 text-center">
                                            <div class="input-daterange input-group" id="datepicker1" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker" data-date-container='#datepicker1'>
                                                <input type="text" class="form-control-sm bt_prs" name="startdate" id="datepicker" placeholder="Start Date" style="font-size: 12px" data-date-container='#datepicker1' data-provide="datepicker" data-date-autoclose="true" autocomplete="off"
                                                    data-date-language="th-th" value="{{ $startdate }}" required/>
                                                <input type="text" class="form-control-sm bt_prs" name="enddate" placeholder="End Date" id="datepicker2" style="font-size: 12px" data-date-container='#datepicker1' data-provide="datepicker" data-date-autoclose="true" autocomplete="off"
                                                    data-date-language="th-th" value="{{ $enddate }}"/>
                                                    <button type="submit" class="ladda-button btn-pill btn btn-sm btn-primary bt_prs" data-style="expand-left">
                                                        <span class="ladda-label">
                                                            <img src="{{ asset('images/Search02.png') }}" class="ms-2 me-2" height="23px" width="23px">
                                                            ค้นหา
                                                        </span>
                                                    </button>
                                                    <a href="{{URL('fire_stock_add')}}" class="ladda-button me-2 btn-pill btn btn-sm btn-info bt_prs">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-12">
                                        <table id="example" class="table table-sm table-striped table-bordered dt-responsive nowrap myTable" style="border-collapse: collapse; border-spacing: 0; width: 100%;background-color: #f5f0f0">
                                                    ...
                                                    <td class="text-center" width="5%">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <a class="dropdown-item menu fontbtn" href="{{ url('fire_stock_edit/' . $item->wh_recieve_id) }}"
                                                                    data-bs-toggle="tooltip" data-bs-placement="left"
                                                                    data-bs-custom-class="custom-tooltip" title="แก้ไขรายการ" style="color: rgb(250, 248, 246)">
                                                                ...
                                                                <a class="dropdown-item menu fontbtn" href="{{url('fire_stock_addsub/'.$item->wh_recieve_id)}}" style="color: rgb(250, 248, 246)" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="เพิ่มรายการ">
                                                            ...
                                                            {{-- <a href="{{url('gas_stocklist_edit/'.$item->wh_recieve_id)}}" class="me-2" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="แก้ไขใบตรวจรับ">
                                                                 <img src="{{ asset('images/Edit.png') }}" height="25px" width="25px">
                                                            </a>
                                                            <a href="{{url('gas_stocklist_addsub/'.$item->wh_recieve_id)}}" target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" title="เพิ่มรายการวัสดุ">
                                                               <img src="{{ asset('images/ShoppingCart01.png') }}" height="25px" width="25px">
                                                            </a> --}}
                        ...
                        <div class="col-md-12 text-end">
                            <div class="form-group">
                                ...
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-sm btn-danger input_new" data-bs-dismiss="modal">
                                    <i class="fa-solid fa-xmark text-white me-2 ms-2"></i>Close
                                </button>
