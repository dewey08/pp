...
@section('content')
    ...
    <div class="tabs-animation">
        ...
        <form action="{{ url('fire_report_month') }}" method="GET">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <h4 style="color:rgb(255, 255, 255)">รายงานผลการตรวจสอบสภาพถังดับเพลิง โรงพยาบาลภูเขียวเฉลิมพระเกียรติ จังหวัดชัยภูมิ </h4>
                ...
                <div class="col-md-2 text-center">
                            ...
                            <a href="{{URL('fire_report_month_pdf')}}" class="ladda-button me-2 btn-pill btn btn-sm btn-primary bt_prs">
                                                ...
                                                @foreach ($datareport as $itemreport)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-start" style="width: 10%;background-color: rgb(2255, 251, 228)">
                                                            {{$itemreport->month_name}} พ.ศ.{{$itemreport->years_th}}
                                                        </td>
