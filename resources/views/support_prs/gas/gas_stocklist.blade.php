                    ...
                    <div class="col-md-12">
                        <div class="card card_audit_4c">
                            ...
                            <div class="card-header">
                                ...
                                <form action="{{ URL('gas_stocklist') }}" method="GET">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-4">
                                            <h4 style="color:rgb(246, 248, 248)">รายละเอียดการตรวจรับเครื่องมือแพทย์</h4>
                                        </div>
                                        {{-- <div class="col"></div>  --}}
                                        <div class="col-md-2 text-end">
                                        ...
                                        <div class="col-md-2 text-end">
                                            ...
                                            <a href="{{URL('gas_stocklist_add')}}" class="ladda-button me-2 btn-pill btn btn-sm btn-info input_new">
