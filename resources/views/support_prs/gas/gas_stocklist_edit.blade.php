...
@section('content')
    ...
    use App\Http\Controllers\StaticController;
        use App\Http\Controllers\MedicalgasController;
        use App\Models\Products_request_sub;
        $ref_gasnonumber = MedicalgasController::ref_gasnonumber();
    ?>
                ...
                <div class="col-md-12">
                    <div class="card card_audit_4c">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="text-start" style="color:rgb(8, 138, 120);">แก้ไขใบตรวจรับ </h4>
                                </div>
                                <div class="col"></div>
                                <div class="col-md-4 text-end">
                                   ...
                                   <a href="{{url('gas_stocklist')}}" class="ladda-button me-2 btn-pill btn btn-sm btn-danger buttom_border">
                            ...
                            <div class="row mt-3 mb-3">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group text-start">
                                        <input type="text" class="form-control-sm input_new" id="recieve_no" name="recieve_no" value="{{$data_edit->recieve_no}}" style="width: 100%" readonly>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group text-start">
                                        <input type="text" class="form-control-sm input_new" id="recieve_po_sup" name="recieve_po_sup" value="{{$data_edit->recieve_po_sup}}" style="width: 100%" placeholder="เลขที่บิลบริษัท">
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group text-center">
                                        <div class="input-daterange input-group" id="datepicker1" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker" data-date-container='#datepicker1'>
                                            <input type="text" class="form-control-sm d12font input_new" name="datepicker" id="datepicker" placeholder="Start Date" data-date-autoclose="true" autocomplete="off"
                                                data-date-language="th-th" value="{{$data_edit->recieve_date}}"/>
                                        </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <input type="time" class="form-control-sm input_new" id="recieve_time" name="recieve_time" value="{{$data_edit->recieve_time}}" style="width: 100%">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-2">
                ...
                Swal.fire({ position: "top-end",
                        ...
                        confirmButtonText: 'Yes, Add it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('prs.gas_stocklist_update') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {recieve_no,recieve_date,recieve_time,vendor_id,stock_list_id,bg_yearnow,recieve_po_sup,wh_recieve_id},
