                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 text-start">
                                ...
                                <select name="active" id="active" class="form-control" style="color:rgb(19, 154, 233);font-size:16px;background-color: white">
                        ...
                        confirmButtonText: 'Yes, Insert it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    ...
                                    type: "POST",
                                    dataType: 'json',
                                    data: {check_date,gas_type,standard_value,standard_value_min,pressure_value,pariman_value,gas_list_id,active},
