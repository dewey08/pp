                        ...
                        <table id="example" class="table table-hover table-sm dt-responsive nowrap myTable" style=" border-spacing: 0; width: 100%;">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Nitrous oxide </th>
                                            <th class="text-center" >Pneumatic Air</th>
                                            <th class="text-center" >Vacuum </th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($datashow as $item)
                                            <tr id="tr_{{$item->gas_list_num}}">
                                                ...
                                                <td class="text-center" style="font-size: 12px">{{ $item->location_name }}</td>
                                                <td class="text-center" width="10%" style="font-size: 12px">{{ $item->class }}</td>
                                                <td class="text-center" width="10%" style="font-size: 12px">{{ $item->detail }}</td>
                                                <td class="text-center" width="10%" style="font-size: 12px">{{ $item->oxygen_check }}</td>
                                                <td class="text-center" width="7%" style="font-size: 12px">{{ $item->nitrous_oxide_check }}</td>
                                                <td class="text-center" width="7%" style="font-size: 12px">{{ $item->pneumatic_air_check }}</td>
                                                <td class="text-center" width="7%" style="font-size: 12px">{{ $item->vacuum_check }}</td>
