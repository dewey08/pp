                        ...
                        <div class="page-title-heading">
                            <div>
                                <div class="page-title-head center-elem">
                                    ...
                                    <span class="d-inline-block"><h3>ตรวจสอบและบำรุงรักษา ระบบสนับสนุนบริการสุขภาพ Dashboard ก๊าซทางการแพทย์</h3></span>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                            <div class="row">
                                ...
                                @php
                                     $qty1 = DB::select(
                                        'SELECT SUM(qty) as qty1 FROM wh_recieve_sub aa LEFT JOIN gas_list bb ON bb.gas_list_num = aa.pro_code
                                        WHERE aa.stock_list_id = "'.$item->stock_list_id.'" AND bb.gas_type = "'.$item->stock_type.'"
                                    ');
                                    foreach ($qty1 as $key => $va1) {$qty_1 = $va1->qty1;}
                                @endphp
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex">
                                                <div class="flex-grow-1">
                                                    <p class="text-truncate font-size-14 mb-2">{{$item->gas_type_name}}</p>
                                                    <h2 class="mb-2">{{$qty_1}} </h2>
                                                </div>
                                                <div class="avatar-sm" style="width: 70px;height:60px">
                                                    <span class="avatar-title bg-light text-primary rounded-3">
                                                        <img src="{{ asset('images/gas_circle.png') }}" height="50px" width="50px" class="text-danger">
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="d-flex align-content-center flex-wrap">
                                                <p class="text-muted mb-0">
                                                    <span class="text-success fw-bold font-size-20 me-2">
                                                        <i class="ri-arrow-right-up-line me-1 align-middle"></i>พร้อมใช้งาน 
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
