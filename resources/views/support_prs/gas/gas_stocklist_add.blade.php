                            ...
                            <div class="row mt-3 mb-3">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group text-start">
                                        <input type="text" class="form-control-sm input_new" id="recieve_no" name="recieve_no" value="{{$ref_gasnonumber}}" style="width: 100%" readonly>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group text-start">
                ...
                Swal.fire({ position: "top-end",
                        ...
                        confirmButtonText: 'Yes, Add it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('prs.gas_stocklist_save') }}",
                                    type: "POST",
                                    dataType: 'json',
