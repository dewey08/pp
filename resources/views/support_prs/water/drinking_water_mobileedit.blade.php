                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    @if ($data_edit->water_img == null)
                                        <img src="{{ asset('assets/images/default-image.jpg') }}" id="add_upload_preview" height="450px" width="415px" alt="Image" class="img-thumbnail bg_prs">
                                    @else
                                        <img src="{{ asset('storage/water/' . $data_edit->water_img) }}" id="add_upload_preview" height="450px" width="415px" alt="Image" class="img-thumbnail bg_prs"> 
                                    @endif
                                    <br>
                        ...
                        <div class="row mt-2"> 
                            <div class="col"> 
                                <div class="input-group">
                                    ...
                                    <select class="js-example-responsive" id="water_year" name="water_year" style="width: 50%">  
                        ...
                        <div class="row mt-2">
                            <div class="col">                                      
                                <div class="input-group input-group-sm">
                                    ...
                                    <select class="js-example-responsive" id="location_id" name="location_id" style="width: 50%">  
                        ...
                        <div class="row mt-2"> 
                            <div class="co"> 
                                <div class="input-group">
                                    ...
                                    <select class="js-example-responsive show_unit" id="unit_id" name="unit_id" style="width: 50%">  
                        ...
                        <div class="row mt-2"> 
                            <div class="col"> 
                                <div class="input-group">
                                    ...
                                    <select class="js-example-responsive show_brand" id="brand_id" name="brand_id" style="width: 50%">  
