                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <img src="{{ asset('assets/images/default-image.jpg') }}" id="add_upload_preview"
                                                alt="Image" class="img-thumbnail bg_prs" width="450px" height="415px">
                                            <br>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col">                                      
                                        <div class="input-group input-group-sm">
                                            ...
                                            <select class="js-example-responsive" id="location_id" name="location_id" style="width: 65%">  
                                ...
                                <div class="row mt-2"> 
                                    <div class="col"> 
                                        <div class="input-group">
                                            ...
                                            <select class="js-example-responsive show_unit" id="unit_id" name="unit_id" style="width: 65%">  
