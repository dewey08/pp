        ...
        <div class="container-fluid mb-4">
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <p >คู่มือการใช้งาน-เบิกพัสดุ(รายการ)</p>
                    <div class="card card_video">
                        <video class="ratio ratio-16x9 p-2" controls>
                            {{-- <source src="{{URL::asset("/upload/video/$itemContent->file_name")}}" type="video/mp4"> --}}
                            <source src="{{URL::asset("/upload/video/wh_request.mp4")}}" type="video/mp4">
                        </video>
                    </div>
                </div>
                <div class="col-md-3">
                    <p >คู่มือการใช้งาน-เบิกพัสดุ(รูปภาพ)</p>
                    <div class="card card_video">
                        <video class="ratio ratio-16x9 p-2" controls>
                            <source src="{{URL::asset("/upload/video/wh_request_pic.mp4")}}" type="video/mp4">
                        </video>
                    </div>
               </div>
               {{-- <div class="col-md-3">
            ...
            <div class="row mt-3">
                    ...
                    @if ($pre_audit !=0)
                        <div class="col-xl-3 col-md-3">
                            <a href="{{ url('pre_audit') }}" target="_blank">
                                <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgb(250, 128, 124);height: 80px;">
                                    <div class="grid-menu-col">
                                        <div class="g-0 row">
                                            <div class="col-sm-12">
                                                <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                                                    <div class="d-flex ">
                    ...
                    @if ($countpesmiss_per != 0)
                        <div class="col-xl-3 col-md-3">
                            <a href="{{ url('person/person_index') }}" target="_blank">
                                <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgb(236, 188, 198);height: 80px;">
                                    <div class="grid-menu-col">
                                        <div class="g-0 row">
                                            <div class="col-sm-12">
                                                <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    @if ($countpermiss_ot != 0)
                        <div class="col-xl-3 col-md-3">
                            <a href="{{ url('otone') }}" target="_blank">
                                <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgb(199, 181, 240);height: 80px;">
                                    <div class="grid-menu-col">
                                        <div class="g-0 row">
                                            <div class="col-sm-12">
                                                <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    @if ($timeot != 0)
                        <div class="col-xl-3 col-md-3">
                            <a href="{{ url('time_dashboard') }}" target="_blank">
                                <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgb(152, 226, 224);height: 80px;">
                                    <div class="grid-menu-col">
                                        <div class="g-0 row">
                                            <div class="col-sm-12">
                                                <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('plan') }}" target="_blank">
                            <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgb(247, 217, 217);height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('medical/med_calenda') }}" target="_blank">
                            <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgb(170, 167, 250);height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('wh_dashboard') }}" target="_blank">
                            <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgb(252, 101, 1);height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('account_info') }}" target="_blank">
                            <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgb(255, 83, 120);height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('account_monitor_main') }}" target="_blank">
                            <div class="main-card mb-2 card shadow-lg rounded-pill" style="background-color: rgb(247, 32, 103);height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('account_monitor_main') }}" target="_blank">
                            <div class="main-card mb-2 card shadow-lg rounded-pill" style="background-color: #f47fbd;height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('p4p') }}" target="_blank">
                            <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgba(248, 17, 144, 0.781);height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('env_dashboard') }}" target="_blank">
                            <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: #65d0c1;height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('prenatal_care_db') }}" target="_blank">
                            <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgb(209, 180, 255);height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('medicine_salt') }}" target="_blank">
                            <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgba(106, 218, 190, 0.884);height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('pkclaim_info') }}" target="_blank">
                            <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgb(247, 198, 176);height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('ct_rep') }}" target="_blank">
                            <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgba(23, 189, 147, 0.74);height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('report_db') }}" target="_blank">
                            <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgba(209, 180, 255, 0.74);height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('audiovisual_admin') }}" target="_blank">
                            <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgba(125, 148, 252, 0.74);height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('tb_main') }}" target="_blank">
                            <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgba(93, 199, 241, 0.74);height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        ...
                        <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgba(255, 197, 255, 0.74);height: 80px;">
                            <div class="grid-menu-col">
                                <div class="g-0 row">
                                    <div class="col-sm-12">
                                        <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    @if ($per_prs != 0)
                        <div class="col-xl-3 col-md-6">
                            <a href="{{ url('support_main') }}" target="_blank">
                                <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgba(147, 204, 248, 0.871);height: 80px;">
                                    <div class="grid-menu-col">
                                        <div class="g-0 row">
                                            <div class="col-sm-12">
                                                <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('fdh_dashboard') }}" target="_blank">
                            <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgba(21, 177, 164, 0.871);height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
                    ...
                    <div class="col-xl-3 col-md-3">
                        <a href="{{ url('nurse_index') }}" target="_blank">
                            <div class="main-card mb-3 card shadow-lg rounded-pill" style="background-color: rgba(242, 205, 252, 0.871);height: 80px;">
                                <div class="grid-menu-col">
                                    <div class="g-0 row">
                                        <div class="col-sm-12">
                                            <div class="widget-chart widget-chart-hover rounded-pill mt-2">
