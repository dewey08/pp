            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <form action="{{ URL('account_pkti8022_search') }}" method="GET">
                            @csrf
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datashow as $item)
                                        ...
                                        <tr height="20" style="font-size: 14px;">
                                            ...
                                            <td class="text-end" style="color:rgb(184, 12, 169)" width="6%">{{ number_format(($item->debit_total-$item->Total_amount),2)}}</td> 
                                            <td class="text-end" style="color:rgb(216, 95, 14)" width="6%">{{ number_format($item->Total_amount,2)}}</td> 
                                            ...
                                            <?php
                                                ...
                                                $total8 = $total8 + $item->Total_amount;
