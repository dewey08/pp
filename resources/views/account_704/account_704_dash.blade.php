...
<div class="tabs-animation">
    ...
    <div id="preloader">
        ...
        <form action="{{ route('acc.account_704_dash') }}" method="GET">
            ...
            <div class="row">
                <div class="col-md-3 ">
                    <h5 class="card-title" style="color:rgb(247, 31, 95)">Detail 1102050101.704</h5>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datashow as $item)
                                        <?php
                                            ...
                                            // STM 502
                                            // $stm_ = DB::select(
                                            //     'SELECT sum(stm_money) as stm_money,count(DISTINCT an) as Countvisit FROM acc_1102050101_504
                                            ...
                                            // }
                                             ...
                                             $sumapprove_ = DB::select('
                                                SELECT count(DISTINCT a.an) as Countvisit ,sum(au.pricereq_all) as pricereq_all
                                                    FROM acc_1102050101_704 a
                                            ...
                                            foreach ($sumapprove_ as $key => $value3) {
                                                $sum_stm_money  = $value3->pricereq_all;
                                                $count_stm      = $value3->Countvisit;
                                            }
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end" style="color:rgb(6, 82, 170);background-color: rgb(203, 227, 255)" width="10%">
                                                    <a href="{{url('account_704_pull')}}" target="_blank" style="color:rgb(5, 58, 173);"> {{ number_format($sum_N, 2) }}</a>
                                                </td>
                                                <td class="text-end" style="color:rgb(231, 73, 139);background-color: rgb(203, 227, 255)" width="10%">
                                                    <a href="{{url('account_704_detail/'.$item->months.'/'.$item->year)}}" target="_blank" style="color:rgb(231, 73, 139);"> {{ number_format($total_sumY, 2) }}</a>
                                                </td>
