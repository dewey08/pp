        ...
        <div id="status">
            ...
            <form action="{{ route('acc.account_801_dash') }}" method="GET">
                ...
                <div class="row">
                    <div class="col"></div>
                    <div class="col-md-7">
                        <h4 class="card-title" style="color:rgb(247, 31, 95)">Detail 1102050102.801</h4>
                            ...
                            <div class="table-responsive p-3">
                                <table id="example" class="table table-sm table-striped table-bordered dt-responsive nowrap myTable"
                                    ...
                                    <tr style="background-color: #f3fca1">
                                        ...
                                        <td class="text-end" style="background-color: #47A4FA"><label for="" style="color: #047aa8">{{ number_format($total1, 2) }}</label></td>
                                        <td class="text-end" style="background-color: #033a6d"><label for="" style="color: #047aa8">{{ number_format($total2, 2) }}</label></td>
                                        <td class="text-end" style="background-color: #fc5089"><label for="" style="color: #047aa8">{{ number_format($total3, 2) }}</label></td>
                                        <td class="text-end" style="background-color: #149966" ><label for="" style="color: #047aa8">{{ number_format($total4, 2) }}</label></td>
                                        {{-- <td class="text-end" style="background-color: #2e41e9" ><label for="" style="color: #047aa8">{{ number_format($total7, 2) }}</label></td>  --}}
                                        {{-- <td class="text-end" style="background-color: #c5224b"><label for="" style="color: #047aa8">{{ number_format($total5, 2) }}</label></td> --}}
                                        {{-- <td class="text-end" style="background-color: #0ea080"><label for="" style="color: #047aa8">{{ number_format($total6, 2) }}</label></td>  --}}
                                        <td class="text-end" style="background-color: #f89625"><label for="" style="color: #047aa8">{{ number_format($total5, 2) }}</label></td>
