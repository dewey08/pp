...
@section('title','ZOffice || ลาติดตามคู่สมรส')
@section('content')
<script>
  function TypeAdmin() {
...
<div class="container-fluid">
    <div class="px-0 py-0 border-bottom mb-2">
      <div class="d-flex flex-wrap justify-content-center">  
        ...
        <div class="text-end">   
          <a type="button" class="btn btn-primary"> ลาติดตามคู่สมรส</a>
        </div>
      </div>
    </div>
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('ลาติดตามคู่สมรส') }}</div>
