...
<div class="container-fluid">
  <div class="px-0 py-0 border-bottom mb-2">
    <div class="d-flex flex-wrap justify-content-center">  
      ...
      <div class="text-end">
        <a href="{{url('user/gleave_data_dashboard/'.Auth::user()->id)}}" class="btn btn-info text-white me-2">dashboard</a>
        <a href="{{url('user/gleave_data_add/'.Auth::user()->id)}}" class="btn btn-light text-dark me-2">เพิ่มข้อมูลการลา</a>
