            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0" style="color:rgb(248, 28, 83)">Detail 1102050101.504</h4>
                        <form action="{{ route('acc.account_504_search') }}" method="GET">
                            @csrf
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datashow as $item)
                                        ...
                                        <tr height="20" style="font-size: 14px;">
                                            ...
                                            <td class="text-center" style="color:rgb(11, 81, 212)" width="7%">{{ number_format($item->income,2)}}</td>
                                            <td class="text-center" style="color:rgb(9, 158, 126)" width="7%">{{ number_format($item->rcpt_money,2)}}</td>
                                            <td class="text-center" style="color:rgb(73, 147, 231)" width="7%">{{ number_format($item->debit_total,2)}}</td>
                                            <td class="text-center" style="color:rgb(184, 12, 169)" width="7%">{{ number_format(($item->debit_total-$item->stm_money),2)}}</td>
                                            <td class="text-center" style="color:rgb(4, 170, 134)" width="7%">{{ number_format($item->stm_money,2)}}</td>
