    ...
    <div class="col-md-12">  
        <div class="card">
          <div class="card-header"> 
                ...
                <button href="" class="col-6 col-lg-auto mb-lg-0 me-lg-auto btn btn-light btn-sm text-dark me-1">หนังสือราชการ</button> 
                <div class="text-end"> 
                    <a href="{{url("po/po_bookindex_retire/".$dataedits->bookrep_id)}}" class="btn btn-success btn-sm text-white">
