            ...
            <div class="col-xl-8 col-md-6">
                <div class="card card_audit_4c mb-3" style="background-color: rgb(246, 235, 247)">
                    <div class="grid-menu-col">
                        <form action="{{ route('acc.kontoon_imc_save') }}" method="POST" enctype="multipart/form-data">
                            {{-- id="upstmdata" --}}
                            @csrf
                            <div class="row">
                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item)
                                    ...
                                    <tr height="20" style="font-size: 12px" >
                                        ...
                                        <td class="text-center" width="5%" > {{ $item->rep_no }}</td>
                                        <td class="text-center" width="5%" > {{ $item->tran_id }}</td>
                                        <td class="text-center" width="5%" > {{ $item->hn }}</td>
                                        <td class="text-center" width="5%" > {{ $item->cid }}</td>
                                        <td class="text-start" width="13%" > {{ $item->ptname }}</td>
                                        <td class="text-center" width="7%"> {{ $item->vstdate }}</td>
                                        <td class="text-center" width="10%" > {{ $item->stm_burk_price }}</td>
                                        <td class="text-center" width="10%" > {{ $item->comment }}</td>
                ...
                Swal.fire({ position: "top-end",
                        ...
                        confirmButtonText: 'Yes, Send it!'
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    url: "{{ route('acc.kontoon_imc_send') }}",
                                    type: "POST",
                                    dataType: 'json',
                                    data: {
                                        datepicker,
