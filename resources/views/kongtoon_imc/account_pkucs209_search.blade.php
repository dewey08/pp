                            ...
                            <tbody>
                                ...
                                @endforeach  
                                    ...
                                    <tr style="background-color: #f3fca1">
                                        ...
                                        <td class="text-end" style="background-color: #088ca3;color:rgb(6, 114, 187)">{{ number_format($total5,2)}}</td> 
                                        <td class="text-end" style="background-color: #0783d6;color:rgb(6, 114, 187)">{{ number_format($total6,2)}}</td> 
                                        <td class="text-end" style="background-color: #e09be9;color:rgb(6, 114, 187)">{{ number_format($total7,2)}}</td> 
                                        <td class="text-end" style="background-color: #f5a382color:rgb(6, 114, 187)">{{ number_format($total8,2)}}</td> 
                                        <td class="text-end" style="background-color: #ff9d9dcolor:rgb(6, 114, 187)"></td> 
                                        <td class="text-end" style="background-color: #f5a382color:rgb(6, 114, 187)">{{ number_format($total9,2)}}</td>  
