...
@section('title', 'ZOFFice || ทำรายการแก้ไขรับสินค้า')
@section('menu')
<script>
    function TypeAdmin() {
...
?>
   <div class="px-3 py-2 border-bottom">
        ...
        <div class="text-end">
            <a href=" " class="btn btn-secondary btn-sm text-white me-2">แก้ไขรับสินค้า </a>
        </div>
        </div>
    </div>
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ทำรายการแก้ไขรับสินค้า
                    </div>
                    <div class="card-body shadow-lg">

                      
                            <form class="custom-validation" action="{{ route('mar.rep_product_update') }}" method="POST" id="update_repForm" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="modal-footer"> 
                                ...
                                <button type="submit" class="btn btn-primary btn-sm"><i class="fa-solid fa-check me-2"></i>แก้ไขข้อมูล</button>
                            </div>
                        </form>
