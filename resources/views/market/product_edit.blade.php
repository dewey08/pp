...
@section('title', 'ZOFFice || แก้ไขรายการสินค้า')
@section('menu')
<script>
    function TypeAdmin() {
...
?>
   <div class="px-3 py-2 border-bottom">
        ...
        <div class="text-end">
            <a href=" " class="btn btn-light btn-sm text-dark me-2">แก้ไขสินค้า </a>
        </div>
        </div>
    </div>
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body shadow-lg">
                        <form class="custom-validation" action="{{ route('mar.product_update') }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input id="product_code" type="text" class="form-control" name="product_code" value="{{ $dataedits->product_code }}">
                                            </div>
                                        </div>
                                        <div class="col-md-2 text-end">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input id="product_name" type="text" class="form-control"
                                                    name="product_name" value="{{ $dataedits->product_name }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input id="product_qty" type="number" class="form-control" name="product_qty" value="{{ $dataedits->product_qty }}">
                                            </div>
                                        </div>
                                        <div class="col-md-2 text-end">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <input id="product_price" type="text" class="form-control"
                                                    name="product_price" value="{{ $dataedits->product_price }}">
                                            </div>
                                        </div>
                                    </div>
