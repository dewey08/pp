                                ...
                                <table class="table table-hover table-bordered table-sm myTable" style="width: 100%;" id="crud_table"> 
                                    <thead>
                                            <tr>
                                                ...
                                                <th> ชื่อ-สกุล</th> 
                                                {{-- <th width="10%"><a class="btn btn-success btn-sm addRow"><i class="fa-solid fa-square-plus"></i></button></th> --}}
                                        ...
                                        <tbody class="tbody">
                                            <tr> 
                                                {{-- <td contenteditable="true" class="person_join_id"></td> --}}
                                                <td>
                          ...
                          $('#carservicessModal').modal('hide');
                            ...
                            $('#addRow').click(function(){     
                                ...
                                var html_code = "<tr id='row"+count+"'>";   
                                    html_code += "<td contenteditable='true' class='person_join_id'></td>";  
