                                              ...
                                              @foreach ($car_service as $item)
                                                  <tr id="sid{{ $item->car_service_id }}" height="30">
                                                      ...
                                                      @elseif ($item->car_service_status == 'allocateall')
                                                        <td class="text-center" width="7%"><div class="badge" style="background: rgb(7, 215, 158)">จัดสรรร่วม</div></td>  
                                                        @elseif ($item->car_service_status == 'noallow')
                                                        <td class="text-center" width="7%"><div class="badge" style="background: rgb(232,13,239)">ไม่อนุมัติ</div></td>    
                                                      ...
                                                      @else
                                                        <td class="text-center" width="7%"><div class="badge bg-success">อนุมัติ</div></td>
                                                      @endif
