        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{-- <form action="{{ route('user_car.car_calenda_save') }}" method="POST" id="car_calenda_save"
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mt-2">
                                        <div class="form-group">
                                            <input id="car_service_book" type="text"
                                                class="form-control form-control-sm input-rounded" name="car_service_book">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select name="car_service_year" id="car_service_year"
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-4 mt-2">
                                        <div class="form-group">
                                            <select name="car_service_location" id="car_service_location"
                                                class="form-control form-control-sm show_location" style="width: 100%;">
                                                @foreach ($car_location as $itemlo)
                                                    <option value="{{ $itemlo->car_location_id }}">
                                                        {{ $itemlo->car_location_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        <div id="signature-pad">
                                            ...
                                            <input type="hidden" id="car_service_no" name="car_service_no"
                                                value="{{ $refnumber }}">
                                            {{-- <input type="hidden" name="car_service_id" id="car_service_id" value=" {{ $dataedits->car_service_id }}"> --}}
                                            <input type="hidden" name="car_service_id" id="car_service_id">
                ...
                $('#calendar').fullCalendar({
                    ...
                    select: function(start, end, allDays) {
                        ...
                        $('#saveBtn').click(function() {
                            ...
                            // });
                            var person_join_id = $('#person_join_id')
                                .val(); // aray mutiselect2
                            // alert(songs);
                            ...
                            var carservice_length_godate = $(
                                '#carservice_length_godate').val();
                            var carservice_length_backdate = $(
                                '#carservice_length_backdate').val();
                            var carservice_length_gotime = $(
                                '#car_service_length_gotime').val();
                            var carservice_length_backtime = $(
                                '#car_service_length_backtime').val();
                            var carservice_article_id = $('#car_service_article_id')
                                .val();
                    ...
                    eventClick: function(event) {
                        ...
                        if (id != '') {
                            ...
                            $.ajax({
                                type: "GET",
                                url: "{{ url('user_car/car_narmal_editshow') }}" +
                                    '/' +
                                    id,
                                success: function(data) {
                                    $('#car_service_no').val(data.carservice
                                        .car_service_no)
                                    $('#car_service_article_id').val(data.carservice
                                        .car_service_article_id)
                                    $('#car_service_book').val(data.carservice
                                        .car_service_book)
                                    $('#car_service_year').val(data.carservice
                                        .car_service_year)
                                    $('#car_service_reason').val(data.carservice
                                        .car_service_reason)
                                    ...
                                    $('#car_service_register').val(data.carservice
                                        .car_service_register)
                                    $('#carservice_length_godate').val(data
                                        .carservice.car_service_date)
                                    $('#carservice_length_backdate').val(data
                                        .carservice.car_service_date)
                                    $('#car_service_length_gotime').val(data
                                        .carservice.car_service_length_gotime)
                                    $('#car_service_length_backtime').val(data
                                        .carservice.car_service_length_backtime)
                                    $('#car_service_userdrive_name').val(data
                                        .carservice.car_service_userdrive_name)
                                    $('#car_service_id').val(data.carservice
                                        .car_service_id)
                                    ...
                                    $('#car_service_location').append(
                                        '<option value="' + data.carservice
                                        .car_location_id + '" > ' + data
                                        .carservice.car_location_name +
