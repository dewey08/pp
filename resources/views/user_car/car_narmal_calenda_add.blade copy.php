      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group"> 
                            <input id="meeting_tel" type="text" class="form-control" name="meeting_tel">
              ...
              <div class="row ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mt-2">
                        <div class="form-outline">
                            <select name="personjoin1" id="personjoin1" class="form-control show_location" style="width: 100%;">
                                @foreach ($car_location as $itemlo)
                                    <option value="{{ $itemlo->car_location_id}}">{{ $itemlo->car_location_name}}</option>
                                @endforeach
                                </select>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-outline">
                        <select name="personjoin2" id="personjoin2" class="form-control show_location" style="width: 100%;">
                            @foreach ($car_location as $itemlo)
                                <option value="{{ $itemlo->car_location_id}}">{{ $itemlo->car_location_name}}</option>
                            @endforeach
                            </select>
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-group">
                        <select name="personjoin6" id="personjoin6" class="form-control show_location" style="width: 100%;">
                            @foreach ($car_location as $itemlo)
                                <option value="{{ $itemlo->car_location_id}}">{{ $itemlo->car_location_name}}</option>
                            @endforeach
                            </select>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-outline">
                        <select name="personjoin3" id="personjoin3" class="form-control show_location" style="width: 100%;">
                            @foreach ($car_location as $itemlo)
                                <option value="{{ $itemlo->car_location_id}}">{{ $itemlo->car_location_name}}</option>
                            @endforeach
                            </select>
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-group">
                        <select name="personjoin7" id="personjoin7" class="form-control show_location" style="width: 100%;">
                            @foreach ($car_location as $itemlo)
                                <option value="{{ $itemlo->car_location_id}}">{{ $itemlo->car_location_name}}</option>
                            @endforeach
                            </select>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-outline">
                        <select name="personjoin4" id="personjoin4" class="form-control show_location" style="width: 100%;">
                            @foreach ($car_location as $itemlo)
                                <option value="{{ $itemlo->car_location_id}}">{{ $itemlo->car_location_name}}</option>
                            @endforeach
                            </select>
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-group">
                        <select name="personjoin8" id="personjoin8" class="form-control show_location" style="width: 100%;">
                            @foreach ($car_location as $itemlo)
                                <option value="{{ $itemlo->car_location_id}}">{{ $itemlo->car_location_name}}</option>
                            @endforeach
                            </select>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-outline">
                        <select name="personjoin5" id="personjoin5" class="form-control show_location" style="width: 100%;">
                            @foreach ($car_location as $itemlo)
                                <option value="{{ $itemlo->car_location_id}}">{{ $itemlo->car_location_name}}</option>
                            @endforeach
                            </select>
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-group">
                        <select name="personjoin9" id="personjoin9" class="form-control show_location" style="width: 100%;">
                            @foreach ($car_location as $itemlo)
                                <option value="{{ $itemlo->car_location_id}}">{{ $itemlo->car_location_name}}</option>
                            @endforeach
                            </select>
          ...
          <div class="modal-footer">
            ...
            <!-- Collapsed content -->
            <div class="collapse mb-5 ms-3 me-3" id="collapseExample">
                ...
                <div class="row">
                    <div class="col-md-2">
                      ...
                      <div class="col-md-2 mt-2">
                            <button type="button" id="closebtn" class="btn btn-primary btn-sm" >เพิ่ม</button>
                      </div>
                      <div class="col-md-1">
                      </div>
                </div>
