                                ...
                                <table class="table table-hover table-bordered table-sm myTable" style="width: 100%;" id="crud_table"> 
                                    <thead>
                                            <tr>
                                                ...
                                                <th> ชื่อ-สกุล</th> 
                                                <th width="10%"><button type="button" name="add" id="add" class="btn btn-success btn-sm"><i class="fa-solid fa-square-plus"></i></button></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                {{-- <td width="10%">1</td> --}}
                                                <td>
                                                    <select name="person_join_id[]" id="person_join_id" class="form-control form-control-sm input-rounded" style="width: 100%;">
                                                        <option >--เลือก--</option>
                                                        @foreach ($users as $item1)
                                                            <option value="{{ $item1->id}}">{{ $item1->fname}}  {{ $item1->lname}}</option>
                                                        @endforeach
                                                ...
                                                <td width="10%" class="text-center"><button type='button' name='remove' data-row='row1' class='btn btn-danger btn-sm remove'><i class="fa-solid fa-trash-can"></i></button></td>
                                            </tr>
                                        </tbody>
                                </table>
                            </div>
          ...
          var carservicess = @json($events);
            $('#calendar').fullCalendar({
                ...
                select: function(start, end, allDays) {
                        ...
                        //     html += '<td><select name="item_unit[]" class="form-control selectpicker" data-live-search="true"><option value="">Select Unit</option> </select></td>';
                        //     var remove_button = '';
                        //     if(count > 0)
                        //     {
                        ...
                        $('#add').click(function(){                                                      
                            ...
                            var html_code = "<tr id='row"+count+"'>";  
                                html_code +="<td person_join_id='true' class='person_join_id'>";
                                html_code +="<select name='person_join_id[]' id='person_join_id' class='form-control form-control-sm selectpicker' style='width: 100%'>"; 
                                html_code +="@foreach ($users as $item1)";
                                html_code +="<option value='{{ $item1->id}}'>{{ $item1->fname}}  {{ $item1->lname}}</option>";
                                html_code +="@endforeach";
                                html_code +="</select>";
                                html_code +="</td>";  
                                html_code += "<td width='10%' class='text-center'><button type='button' name='remove' data-row='row"+count+"' class='btn btn-danger btn-sm remove'><i class='fa-solid fa-trash-can'></i></button></td>";   
                                html_code += "</tr>";  
                        ...
                        $('#saveBtn').click(function() {                           
                            ...
                            // consol.log(person_join_id);
                            // alert(person_join_id);
