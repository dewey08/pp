...
<div class="modal fade" id="carservicessModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
      <div class="modal-content">
          <form action="{{ route('user_car.car_calenda_save') }}" method="POST">
            {{-- <form action="{{ route('user_car.car_calenda_save') }}" id="Carcalenda_save" method="POST"> --}}
              @csrf
          ...
          <div class="modal-body"> 
            ...
            {{-- <div class="row">
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-outline">
                        <select name="personjoin2" id="personjoin2" class="form-control form-control-sm input-rounded" style="width: 100%;">
                            <option value="">--เลือก--</option>
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-group">
                        <select name="personjoin6" id="personjoin6" class="form-control form-control-sm input-rounded" style="width: 100%;">
                            <option value="">--เลือก--</option>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-outline">
                        <select name="personjoin3" id="personjoin3" class="form-control form-control-sm input-rounded" style="width: 100%;">
                            <option value="">--เลือก--</option>
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-group">
                        <select name="personjoin7" id="personjoin7" class="form-control form-control-sm input-rounded" style="width: 100%;">
                            <option value="">--เลือก--</option>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-outline">
                        <select name="personjoin4" id="personjoin4" class="form-control form-control-sm input-rounded" style="width: 100%;">
                            <option value="">--เลือก--</option>
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-group">
                        <select name="personjoin8" id="personjoin8" class="form-control form-control-sm input-rounded" style="width: 100%;">
                            <option value="">--เลือก--</option>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-outline">
                        <select name="personjoin5" id="personjoin5" class="form-control form-control-sm input-rounded" style="width: 100%;">
                            <option value="">--เลือก--</option>
                ...
                <div class="col-md-4 mt-2">
                    <div class="form-group">
                        <select name="personjoin9" id="personjoin9" class="form-control form-control-sm input-rounded" style="width: 100%;">
                            <option value="">--เลือก--</option>
