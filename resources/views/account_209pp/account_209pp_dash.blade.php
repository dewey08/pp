...
<div class="tabs-animation">
    ...
    <div id="preloader">
        <div id="status">
            ...
            <form action="{{ URL('account_209pp_dash') }}" method="GET">
                @csrf
                <div class="row"> 
                    <div class="col"></div>
                    <div class="col-md-7">
                        <h4 class="card-title" style="color:green">Detail 1102050101.209</h4>
                        <p class="card-title-desc">รายละเอียดข้อมูล การทดสอบการตั้งครรภ์</p>
                    </div>
                    {{-- <div class="col"></div> --}}
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end" style="color:rgb(6, 82, 170);background-color: rgb(203, 227, 255)" width="10%">
                                                        {{-- <a href="{{url('account_401_claim_detail/'.$item->months.'/'.$item->year)}}" target="_blank" style="color:rgb(4, 170, 134);"> --}}
                                                             {{ number_format($total_claim, 2) }}
                                                            {{-- </a> --}}
                                                    </td> 
                                                    <td class="text-end" style="color:rgb(6, 82, 170);background-color: rgb(203, 227, 255)" width="10%">
                                                    ...
                                                    <td class="text-end" style="color:rgb(6, 82, 170);background-color: rgb(203, 227, 255)" width="10%">
                                                        {{-- <a href="{{url('account_401_pull')}}" target="_blank" style="color:rgb(5, 58, 173);"> --}}
                                                             {{ number_format($sum_N, 2) }}
                                                            {{-- </a> --}}
                                                    </td>                                                    
                                                    <td class="text-end" style="color:rgb(231, 73, 139);background-color: rgb(203, 227, 255)" width="10%"> 
                                                        {{-- <a href="{{url('account_401_detail/'.$item->months.'/'.$item->year)}}" target="_blank" style="color:rgb(231, 73, 139);">  --}}
                                                            {{ number_format($total_sumY, 2) }}
                                                        {{-- </a>  --}}
                                                    </td> 
                                                    <td class="text-end" style="color:rgb(2, 116, 63);background-color: rgb(203, 227, 255)" width="10%"> 
                                                         {{-- <a href="{{url('account_401_stm/'.$item->months.'/'.$item->year)}}" target="_blank" style="color:rgb(2, 116, 63);"> --}}
                                                             {{ number_format($sum_stm_money, 2) }}
                                                            {{-- </a>  --}}
                                                    </td> 
                                                  
                                                    <td class="text-end" style="color:rgb(224, 128, 17)" width="10%">  
                                                        {{-- <a href="{{url('account_401_yok/'.$item->months.'/'.$item->year)}}" target="_blank" style="color:rgb(224, 128, 17);"> --}}
