...
@section('content')
    ...
    <div class="tabs-animation">
        ...
        <form action="{{ URL('account_rep_4022') }}" method="GET">
            @csrf
        <div class="row">
            <div class="col-md-4">
                <h3 class="card-title" style="color:rgb(10, 168, 134)">Detail Send Data 1102050101.4022</h3>
                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item)
                                    ...
                                    <tr height="20" style="font-size: 14px;">
                                        ...
                                        <td class="text-center" width="6%">{{ $item->rxdate }}</td>
                                        ...
                                        <td class="text-center" style="color:rgb(184, 12, 169)" width="6%">{{ number_format(($item->debit_total-$item->total),2)}}</td> 
                                        <td class="text-center" style="color:rgb(4, 132, 141)" width="6%">{{ number_format($item->total,2)}}</td>
                                        ...
                                        <?php
                                            ...
                                            $total7 = $total7 + ($item->debit_total-$item->total);
                                            // $total8 = $total8 + $item->rep_pay;
                                            $total9 = $total9 + $item->total;
                                        ?>
                                @endforeach
                                        ...
                                        <tr style="background-color: #f3fca1">
                                            ...
                                            <td class="text-center" style="background-color: #bbf0e3;color: #078d9e">{{ number_format($total9,2)}}</td>
