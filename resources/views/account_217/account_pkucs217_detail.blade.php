                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                                ...
                                @foreach ($data as $item)
                                    ...
                                    <tr height="20">
                                        ...
                                        <td class="text-center" width="10%">{{ $item->vn }}</td>
                                                ...
                                                <td class="text-center" style="color:rgb(73, 147, 231)" width="10%">
                            ...
                            <tr style="background-color: #f3fca1">
                                ...
                                <td class="text-center" style="background-color: #47A4FA"><label for="" style="color: #0669aa">{{ number_format($total1, 2) }}</label></td>
