  ...
  .btn{
   ...
   .page{
    ...
    <div class="px-3 py-2 border-bottom">
        ...
        <a href="{{url('hn/hn_purchaseindex/'.Auth::user()->id)}}" class="btn btn-warning btn-sm text-white me-2 mt-2">&nbsp;จัดซื้อจัดจ้าง<span class="badge bg-danger ms-2">{{$count_suprephn}}</span>&nbsp;</a> 
