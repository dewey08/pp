            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="card-title" style="color:rgb(247, 31, 95)">Search Detail 1102050102.603</h4>
                        <form action="{{ URL('account_603_search') }}" method="GET">
                            @csrf
                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item)
                                    ...
                                    <tr height="20" style="font-size: 14px;">
                                        ...
                                        <td class="text-center" style="color:rgb(16, 143, 216)" width="6%">{{ number_format($item->income,2)}}</td>
                                        <td class="text-center" style="color:rgb(155, 50, 18)" width="6%">{{ number_format($item->rcpt_money,2)}}</td>
                                        <td class="text-center" style="color:rgb(3, 146, 134)" width="6%">{{ number_format($item->debit_total,2)}}</td>
