...
<div class="tabs-animation">
    ...
    <div id="preloader">
        <div id="status">
            ...
            <form action="{{ URL('account_603_dash') }}" method="GET">
                @csrf
                <div class="row">
                    <div class="col"></div>
                    <div class="col-md-7">
                        <h4 class="card-title" style="color:rgb(247, 31, 95)">Detail 1102050102.603</h4>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($datashow as $item)
                                            <?php
                                                ...
                                                // STM
                                                $stm_ = DB::select(
                                                    'SELECT count(DISTINCT U1.an) as Countvisit ,sum(U1.nhso_ownright_pid) as stm_money
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end" style="color:rgb(6, 82, 170);background-color: rgb(203, 227, 255)" width="10%">
                                                        <a href="{{url('account_603_pull')}}" target="_blank" style="color:rgb(5, 58, 173);"> {{ number_format($sum_N, 2) }}</a>
                                                    </td>
                                                    <td class="text-end" style="color:rgb(231, 73, 139);background-color: rgb(203, 227, 255)" width="10%">
                                                        <a href="{{url('account_603_detail/'.$item->months.'/'.$item->year)}}" target="_blank" style="color:rgb(231, 73, 139);"> {{ number_format($total_sumY, 2) }}</a>
                                                    </td>
