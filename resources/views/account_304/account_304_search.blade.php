...
@section('content')
    ...
    <div class="tabs-animation">
        ...
        <div id="preloader">
            ...
            {{-- <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h5 class="card-title" style="color:rgb(248, 28, 83)">Detail Pang 1102050101.304</h5>
            ...
            <!-- end page title -->
        <form action="{{ url('account_304_search') }}" method="GET">
            @csrf
            <div class="row">
                <div class="col-md-4">

                    <h4 class="card-title" style="color:rgb(248, 28, 83)">Detail 1102050101.304 </h4>
                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item)
                                    ...
                                    <tr height="20" style="font-size: 14px;">
                                        ...
                                        <td class="text-center" style="color:rgb(6, 83, 170)" width="7%">{{ number_format($item->income,2)}}</td>
                                        <td class="text-center" style="color:rgb(6, 83, 170)" width="7%">{{ number_format($item->claim,2)}}</td>
                                        <td class="text-center" style="color:rgb(10, 117, 150)" width="7%">{{ number_format($item->debit_total,2)}}</td>
                                        <td class="text-center" style="color:rgb(4, 156, 118)" width="7%">{{ number_format($item->stm,2)}}</td>
                                        <td class="text-center" style="color:rgb(131, 6, 93)" width="7%">{{ number_format($item->difference,2)}}</td>
                                        <td class="text-center" style="color:rgb(131, 6, 93)" width="7%">{{ $item->stm_no }}</td>
                                        <td class="text-center" style="color:rgb(131, 6, 93)" width="7%">{{ $item->date_save }}</td>
