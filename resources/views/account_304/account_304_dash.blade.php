                                ...
                                <table id="example" class="table table-sm table-striped table-bordered dt-responsive nowrap myTable"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="background-color: rgb(135, 190, 253)">Stm New</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($datashow as $item)
                                            <?php
                                                ...
                                                // STM 304 new
                                                $stm_new = DB::select(
                                                    'SELECT sum(stm) as stmnew
                                                    FROM acc_1102050101_304
                                                    WHERE month(dchdate) = "'.$item->months.'" AND year(dchdate) = "'.$item->year.'"
                                                    AND (stm IS NOT NULL OR stm <> "")
                                                ');
                                                foreach ($stm_new as $key => $value6) {
                                                    $sum_stm_new  = $value6->stmnew;
                                                }
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end" style="color:rgb(2, 116, 63);background-color: rgb(203, 227, 255)" width="10%">
                                                        <a href="" target="_blank" style="color:rgb(2, 116, 63);"> {{ number_format($sum_stm_new, 2) }}</a>
                                                   </td>
                                            ...
                                            <?php
                                                    ...
                                                    $total6 = $total6 + $sum_stm_new;
                                            ?>
                                        @endforeach

                                    </tbody>
                                    <tr style="background-color: #f3fca1;font-size:14px">
                                        ...
                                        {{-- <td class="text-end" style="background-color: #2e41e9" ><label for="" style="color: #000000">{{ number_format($total7, 2) }}</label></td>  --}}
                                        {{-- <td class="text-end" style="background-color: #c5224b"><label for="" style="color: #000000">{{ number_format($total5, 2) }}</label></td> --}}
                                        <td class="text-end" style="background-color: #0ea080"><label for="" style="color: #000000">{{ number_format($total6, 2) }}</label></td>
