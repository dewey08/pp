                                ...
                                <table id="example" class="table table-sm table-striped table-bordered dt-responsive nowrap myTable"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="background-color: rgb(135, 190, 253)">Stm2</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($datashow as $item)
                                            <?php
                                                ...
                                                $stm_2 = DB::select(
                                                    'SELECT sum(stm) as stm,count(DISTINCT vn) as Countvisits
                                                    FROM acc_1102050101_309
                                                    WHERE month(vstdate) = "'.$item->months.'" AND year(vstdate) = "'.$item->year.'"
                                                    AND (stm IS NOT NULL OR stm <> "")
                                                ');
                                                foreach ($stm_2 as $key => $value33) {
                                                    $sum_stm2        = $value33->stm;
                                                    $count_stm2      = $value33->Countvisits;
                                                }
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end" style="color:rgb(2, 116, 63);background-color: rgb(203, 227, 255)" width="10%">
                                                        <a href="{{url('account_309_stm2/'.$item->months.'/'.$item->year)}}" target="_blank" style="color:rgb(2, 116, 63);"> {{ number_format($sum_stm2, 2) }}</a>
                                                   </td>
                                                    <td class="text-end" style="color:rgb(224, 128, 17)" width="10%">
                                                        <a href="{{url('account_309_yok/'.$item->months.'/'.$item->year)}}" target="_blank" style="color:rgb(224, 128, 17);"> {{ number_format($sum_yokpai-$sum_stm2, 2) }}</a>
                                                    </td>
                                                </tr>
                                            <?php
