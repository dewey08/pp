        ...
        <div class="row">
            <div class="col-xl-12">
                    ...
                    {{-- <div class="card-header">
                        <h4 class="card-title" style="color:rgb(10, 151, 85)">รายละเอียด 1102050101.309</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <div class="row mb-3">
                                {{-- <div class="col-md-4 text-start">   <h4 class="card-title" style="color:rgb(10, 151, 85)">รายละเอียด 1102050101.309</h4></div> --}}
                                <div class="col"></div>
