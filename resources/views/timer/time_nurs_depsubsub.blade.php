            ...
            <div class="card-header">
                ...
                <div class="btn-actions-pane-right">
                    <div class="nav">
                        ...
                        <a data-bs-toggle="tab" href="{{ url('time_nurs_depsubsub') }}" class="btn-pill me-2 btn btn-outline-primary btn-sm active input_time">หน่วยงาน</a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 text-center">
                                            <div class="input-group">
                                                <select id="HR_DEPARTMENT_SUB_SUB_ID" name="HR_DEPARTMENT_SUB_SUB_ID" class="form-select form-select-lg department_sub_sub" style="width: 100%;font-size: 13px">
                                        ...
                                        {{-- <div class="col-md-2 me-2">
                                            ...
                                            <a href="{{url('time_nurs_depsubsubexcel/'.$debsubsub.'/'.$startdate.'/'.$enddate)}}" class="mb-2 me-2 btn-icon btn-sm btn-shadow btn-dashed btn btn-outline-success">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <a href="{{url('time_nurs_depsubsubexcel/'.$debsubsub.'/'.$startdate.'/'.$enddate)}}" class="ladda-button btn-pill btn btn-sm btn-success input_time">
