...
<div class="tabs-animation">
        ...
        <div class="card input_time" style="background-color: rgb(236, 247, 248)">
            <div class="card-header">
                ลงเวลาเข้า-ออก กลุ่มงาน/ฝ่าย
                <div class="btn-actions-pane-right">
                    <div class="nav">
                        <a href="{{ url('time_nurs_dep') }}" class="btn btn-outline-info btn-sm input_time">กลุ่มภารกิจ</a>
                        <a data-bs-toggle="tab" href="{{ url('time_nurs_depsub') }}" class="btn-pill me-2 ms-2 btn btn-outline-primary active btn-sm input_time">กลุ่มงาน/ฝ่าย</a>
                        <a href="{{ url('time_nurs_depsubsub') }}" class="btn-pill me-2 btn btn-outline-info btn-sm input_time">หน่วยงาน</a>
                        <a href="{{ url('time_nurs_person') }}" class="btn-pill btn btn-outline-info btn-sm input_time">บุคคล</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 text-center">
                                            <div class="input-group">
                                                <select id="HR_DEPARTMENT_SUB_ID" name="HR_DEPARTMENT_SUB_ID" class="form-select form-select-lg department_sub" style="width: 100%;font-size: 13px">
                                        ...
                                        {{-- <div class="col-md-2">
                                            ...
                                            <a href="{{url('time_nurs_depsubexcel/'.$debsub.'/'.$startdate.'/'.$enddate)}}" class="mb-2 me-2 btn-icon btn-sm btn-shadow btn-dashed btn btn-outline-success">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <a href="{{url('time_nurs_depsubexcel/'.$debsub.'/'.$startdate.'/'.$enddate)}}" class="ladda-button btn-pill btn btn-sm btn-success input_time">
