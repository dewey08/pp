...
<div class="tabs-animation">
        ...
        <div class="card input_time" style="background-color: rgb(236, 247, 248)">
            <div class="card-header">
                ลงเวลาเข้า-ออก กลุ่มภารกิจ

                <div class="btn-actions-pane-right">
                    <div class="nav">
                        <a data-bs-toggle="tab" href="{{ url('time_nurs_dep') }}" class="btn btn-outline-primary btn-sm active input_time">กลุ่มภารกิจ</a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 text-center">
                                            <div class="input-group">
                                                <select id="HR_DEPARTMENT_ID" name="HR_DEPARTMENT_ID" class="form-select form-select-lg department" style="width: 100%;font-size: 13px">
                                                    {{-- <option value="">--</option> --}}
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <a href="{{url('time_nurs_depexcel/'.$deb.'/'.$startdate.'/'.$enddate)}}" class="ladda-button btn-pill btn btn-sm btn-success input_time">
