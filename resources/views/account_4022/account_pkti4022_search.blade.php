...
<div class="tabs-animation"> 
    ...
    <form action="{{ URL('account_pkti4022_search') }}" method="GET">
        @csrf
    <div class="row">
        <div class="col-md-4">
            <h5 class="card-title" style="color:rgb(247, 31, 95)">Search Detail 1102050101.4022</h5>
            <p class="card-title-desc">ค้นหาลูกหนี้ ผัง 1102050101.4022</p>
        </div>
        <div class="col"></div>
        ...
        <div class="col-md-5 text-end">
            <div class="input-daterange input-group" id="datepicker1" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker" data-date-container='#datepicker1'>
                ...
                <button type="button" class="ladda-button me-2 btn-pill btn btn-primary btn-sm input_new Savestamp" data-url="{{url('account_pkti4022_send')}}">
                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item) 
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" width="5%"><input type="checkbox" class="dcheckbox_ sub_chk" data-id="{{$item->acc_1102050101_4022_id}}"> </td>
