...
@section('content')
    ...
    <div class="tabs-animation">
        ...
        <form action="{{ URL('account_804_pull') }}" method="GET">
            @csrf
        <div class="row"> 
            <div class="col-md-4">
                <h4 class="card-title" style="color:rgb(247, 31, 95)">Detail Account ผัง 1102050102.804</h4>
            ...
            <div class="col-md-4 text-end">
                <div class="input-daterange input-group" id="datepicker1" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker" data-date-container='#datepicker1'>
                    ...
                    <button type="button" class="ladda-button btn-pill btn btn-sm btn-primary cardacc" data-style="expand-left" id="Pulldata">
                        <span class="ladda-label"> 
                        ...
                        <div class="row mb-3">
                            <div class="col-md-5 text-start"> 
                                ...
                                @else
                                  ...
                                  <button class="ladda-button me-2 btn-pill btn btn-danger btn-sm input_new" onclick="uncheck()">Uncheck</button>
                                @endif 
                                  <button type="button" class="ladda-button me-2 btn-pill btn btn-sm btn-warning input_new Claim" data-url="{{url('account_804_claim')}}"> 
                                      <img src="{{ asset('images/loading_white.png') }}" class="me-2 ms-2" height="18px" width="18px"> 
                                     ประมวลผล
                                 </button>
                                 <a href="{{url('account_804_zip')}}" class="ladda-button me-2 btn-pill btn btn-sm btn-success input_new"> 
                            ...
                            <div class="col-md-5 text-end">
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-sm btn-info cardacc Check_sit" data-url="{{url('account_804_checksit')}}">
                                    {{-- <i class="fa-solid fa-user me-2"></i> --}}
                                    <img src="{{ asset('images/Check_sitwhite.png') }}" class="me-2 ms-2" height="18px" width="18px"> 
                                    ตรวจสอบสิทธิ์
                                </button> 
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-sm btn-primary cardacc Savestamp" data-url="{{url('account_804_stam')}}"> 
                                    <img src="{{ asset('images/Stam_white.png') }}" class="me-2 ms-2" height="18px" width="18px"> 
                                    ตั้งลูกหนี้
                                </button>
                                <button type="button" class="ladda-button me-2 btn-pill btn btn-sm btn-danger cardacc Destroystamp" data-url="{{url('account_804_destroy')}}"> 
    ...
    <script>
        ...
        onoff = "Y";
          var _token=$('input[name="_token"]').val();
            $.ajax({
                    url:"{{route('acc.account_804_claimswitch')}}",
                    method:"GET",
