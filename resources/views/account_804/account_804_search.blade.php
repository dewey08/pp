...
?>
    ...
    <div class="tabs-animation">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0"  style="color:rgb(10, 151, 85)">Detail Account ผัง 1102050102.804</h4>
        ...
        <form action="{{ URL('account_804_search') }}" method="GET">
            @csrf
        <div class="row">
            <div class="col-md-4">
                <h5 class="card-title" style="color:rgb(247, 31, 95)">Search Detail 1102050102.804</h5>
                <p class="card-title-desc">ค้นหาลูกหนี้ ผัง 1102050102.804</p>
            </div>
            <div class="col"></div>
                            ...
                            <tbody>
                                ...
                                @foreach ($datashow as $item)
                                    ...
                                    <tr height="20" style="font-size: 14px;">
                                        ...
                                        <td class="text-center" width="5%"><input type="checkbox" class="dcheckbox_ sub_chk" data-id="{{$item->acc_1102050102_804_id}}"> </td>
