...
<div class="tabs-animation">
    ...
    <div id="preloader">
        ...
        <div class="row">
            <div class="col-md-4">
                <h4 class="card-title" style="color:rgb(248, 28, 83)">Detail 1102050101.201</h4>
                        ...
                        <div class="table-responsive">
                            <table id="datatable-buttons" class="table table-sm table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tr style="background-color: #f3fca1">
                                    ...
                                    <td class="text-center" style="background-color: #47A4FA"><label for="" style="color: #0e7fe9">{{ number_format($total1, 2) }}</label></td>
                                    <td class="text-center" style="background-color: #9f4efc" ><label for="" style="color: #970eb3">{{ number_format($total2, 2) }}</label></td>
                                    <td class="text-center" style="background-color: #c5224b"><label for="" style="color: #FFFFFF">{{ number_format($total3, 2) }}</label></td>
                                    <td class="text-center" style="background-color: #0ea080"><label for="" style="color: #19a582">{{ number_format($total4, 2) }}</label></td>
                                    <td class="text-center" style="background-color: #f89625"><label for="" style="color: #e6761c">{{ number_format($total5, 2) }}</label></td>
                                    <td class="text-center" style="background-color: #f89625"><label for="" style="color: #e6761c">{{ number_format($total5, 2) }}</label></td>
                                </tr>
