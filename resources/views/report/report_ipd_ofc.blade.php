...
?>
  <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">รายงาน IPD OFC </h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Report</a></li>
                            <li class="breadcrumb-item active">รายงาน IPD OFC</li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <h6 class="mb-0 text-uppercase"> Chart รายงาน IPD OFC</h6>
                <hr />
    ...
    @section('footer')
        ...
        <script>
            ...
            var url = "{{ route('rep.report_ipd_ofc_getbar') }}";
