            ...
            <div class="input-daterange input-group" id="datepicker1" data-date-format="yyyy-mm-dd" data-date-autoclose="true" data-provide="datepicker" data-date-container='#datepicker1'>
                ...
                <input type="text" class="form-control d-shadow" name="enddate" placeholder="End Date" id="datepicker2" data-date-container='#datepicker1' data-provide="datetimepicker" data-date-autoclose="true" autocomplete="off"
                    ...
                    {{-- data-style="expand-left" --}}
                        <button type="submit" class="ladda-button btn-pill btn btn-info d-shadow">
                        ...
                        <button type="button" class="ladda-button btn-pill btn btn-primary d-shadow Pulldata">
                            <span class="ladda-label"> <i class="fa-solid fa-arrows-rotate text-danger text-white me-2"></i>
                                Pull Data
                            </span>
                        ...
                        <button type="button" class="ladda-button btn-pill btn btn-success d-shadow CheckSit">
                            <span class="ladda-label"> <i class="fa-solid fa-user text-danger text-white me-2"></i>
                                Check Sit
                            </span> 
                        </button> 
                </div> 
