        ...
        <div class="row">
            ...
            <div class="col-md-12"> 
                    <div class="card-body ">
                        ...
                        <h4 class="card-title">ตัวชี้วัดสำคัญใน OPD</h4>
                        <p class="card-title-desc">ตัวชี้วัดสำคัญใน OPD</p> 
                                        ...
                                        <div class="row"> 
                                            <div class="col-md-12">
                                                <div class="card p-4 cardreport">
                                                    <h4 class="card-title" style="color:rgb(10, 151, 85)">ตัวชี้วัดสำคัญใน OPD</h4>
                                                                ...
                                                                @foreach ($report_opd as $item)
                                                                    ...
                                                                    <tr height="20">
                                                                        ...
                                                                        <td class="text-start" style="color:rgb(34, 90, 243);font-size:15px">  
                                                                            {{-- <a href="" onclick="testAlert"> --}}
                                                                           
                                                                            @if ($item->active == 'N')
                                                                                <button type="button" class="btn btn-white testAlert"  style="font-size:15px" value="{{$item->report_hos_id}}">
                                                                                    {{ $item->report_hos_name }}
                                                                                </button>
                                                                            @else
                                                                                <a href="{{url('report_hos_opd/'.$item->report_hos_id)}}" target="_blank">
                                                                                    {{ $item->report_hos_name }}
                                                                                </a>
                                                                            @endif
                                                                            {{-- </a> --}}
