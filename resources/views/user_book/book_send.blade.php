...
@section('title','ZOffice || หนังสือส่ง')
@section('content')
<script>
  function TypeAdmin() {
...
<div class="container-fluid" >
  <div class="px-0 py-0 border-bottom mb-2">
    <div class="d-flex flex-wrap justify-content-center">  
      ...
      <div class="text-end">
        <a href="{{url('user/book_inside/'.Auth::user()->id)}}" class="btn btn-light text-dark me-2">หนังสือเข้า</a>
        <a href="{{url('user/book_send/'.Auth::user()->id)}}" class="btn btn-info text-white me-2">หนังสือส่ง</a>
        <a href="{{url('user/book_advertise/'.Auth::user()->id)}}" class="btn btn-light text-dark me-2">ประกาศ</a> 
      </div>
    </div>
  </div>
