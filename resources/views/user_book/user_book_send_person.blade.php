                ...
                <div class="card-body shadow">  
                    <!-- Pills navs -->
                        <ul class="nav nav-pills" id="ex1" role="tablist">
                            ...
                            <li class="nav-item" role="presentation"> 
                                <a class="nav-link active" href="{{url('user_book/user_book_send_person/'.$dataedits->bookrep_id)}}" ><label class="xl">ส่งบุคคลากร</label> </a>
                            </li>
                            <li class="nav-item" role="presentation"> 
                ...
                <div class="card-body shadow-lg "> 
                    ...
                    <div class="tab-content" id="ex1-content">
                        ...
                        <div class="tab-pane fade show active" id="ex1-pills-4" role="tabpanel" aria-labelledby="ex1-tab-4">
                            {{-- <form action="{{route('book.bookmake_index_sendperson')}}" id="Save_sendperson" method="POST">
                                @csrf                             
